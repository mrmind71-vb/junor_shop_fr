...
cString = "SELECT file7_10h.inv_no , FILE7_10H.DOC_NO,FILE7_10H.MOSM ,FILE7_10H.DATE, SUM(FILE7_10.QUANT * FILE7_10.PRICE ) as TITEM ,SUM(FILE7_10.TOTAL) as sumOfTotal, FILE7_10H.DISCOUNT, FILE7_10H.TAX,FILE7_10H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA AS GROUPDESCA , FILE0_40.DESCA AS STORENAME " & _
         " FROM ((FILE7_10H INNER JOIN FILE7_10 ON FILE7_10H.doc_no =   FILE7_10.doc_no) inner join file4_10 on file7_10H.CODE = FILE4_10.CODE) LEFT JOIN FILE4_50 ON FILE4_10.[GROUP] = FILE4_50.CODE  INNER JOIN FILE0_40 ON FILE0_40.CODE = FILE7_10H.STORE "

If Trim(xCode.text) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FILE7_10H.CODE = " & MyParn(xCode.text)
    aHeader(0) = "[" & "«·„Ê—œ : " & xCodeDesca.Caption & "]"
End If

If Trim(xMosm.BoundText) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FILE7_10H.mosm = " & MyParn(xMosm.BoundText)
...
If IsDate(xDate2.text) Then
    cWhere = cWhere & turn(cWhere, " and ") & " FILE7_10H.date <= " & DateSq(xDate2.text)
    aHeader(3) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

cString = cString & turnFound(cWhere) & cWhere
cString = cString & " GROUP BY file7_10h.inv_no , FILE7_10H.DOC_NO, FILE0_40.DESCA ,FILE7_10H.MOSM ,FILE7_10H.DATE, FILE7_10H.DISCOUNT ,FILE7_10H.TAX,FILE7_10H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA"
...
'    temptable!val2 = sourcetable!tax
'    temptable!val3 = sourcetable!sumofTotal + sourcetable!tax
'    temptable!VAL4 = sourcetable!discount
    temptable!VAL1 = sourcetable!sumofTotal + sourcetable!tax - (sourcetable!discount)
    temptable!STR21 = "≈Ã„«·Ì ›Ê« Ì— „—œÊœ „‘ —Ì«  „Ê—œÌ‰ Œ·«· › —…"
