...
Begin VB.Form TPrice_Supl 
   Caption         =   " ﬁÌ„ „ÊœÌ·«  «·„Ê—œÌ‰   »√”⁄«— «·„’‰⁄ Ê «· ﬂ·›… Ê «·»Ì⁄"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   13260
...
'                           0               1                   2
    If xdate2.Value = "" Or Check1.Value = 0 Then
        If xall(0).Value Then
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FILE1_11.[IN] -FILE1_11.OUT) , " & _
                    ...
                    " FROM FILE1_10 INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM inner JOIN file4_10 ON file4_10.CODE = FILE1_10.[code] WHERE FILE1_10.MODELNO IS NOT NULL "
        ElseIf xall(1).Value Then
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
                    ...
                    " FROM FILE1_10 INNER JOIN FR1_11 ON FILE1_10.ITEM = FR1_11.ITEM inner JOIN file4_10 ON file4_10.CODE = FILE1_10.[code] WHERE FILE1_10.MODELNO IS NOT NULL "
        Else
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) , " & _
                    ...
                    " FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM inner JOIN file4_10 ON file4_10.CODE = FILE1_10.[code] WHERE FILE1_10.MODELNO IS NOT NULL "
        End If
    Else
        If xall(0).Value Then
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FILE1_11.[IN] -FILE1_11.OUT) , " & _
                    " SUM(FILE1_10.COST * ( FILE1_11.[IN] -FILE1_11.OUT) ) , SUM( BALITEM2.COST  * ( FILE1_11.[IN] -FILE1_11.OUT) ) , SUM(FILE1_10.PRICE * ( FILE1_11.[IN] -FILE1_11.OUT) )  " & _
                    " FROM FILE1_10 INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM inner JOIN BALITEM2 ON FILE1_10.ITEM = BALITEM2.ITEM inner JOIN FILE4_10 ON FILE4_10.CODE = FILE1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
        ElseIf xall(1).Value Then
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
                    " SUM(FILE1_10.COST * ( FR1_11.[IN] -FR1_11.OUT) ) , SUM( BALITEM2.COST * ( FR1_11.[IN] -FR1_11.OUT) ) , SUM(FILE1_10.PRICE * ( FR1_11.[IN] -FR1_11.OUT) )  " & _
                    " FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM inner JOIN BALITEM2 ON FILE1_10.ITEM = BALITEM2.ITEM inner JOIN FILE4_10 ON FILE4_10.CODE = FILE1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
        Else
            cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) , " & _
                    " SUM(FILE1_10.COST * ( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) ) , SUM(BALITEM2.COST  * ( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) ) , SUM(FILE1_10.PRICE * ( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) )  " & _
                    " FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM inner JOIN BALITEM2 ON FILE1_10.ITEM = BALITEM2.ITEM inner JOIN FILE4_10 ON FILE4_10.CODE = FILE1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
        End If
    End If
...
Dim cStr1 As String
    DelTable
    cStr1 = " SELECT FILE1_10.ITEM ,SUM(FILE1_11_ALL.[IN] - FILE1_11_ALL.OUT) AS Balance " & _
            " , COALESCE ((SELECT TOP (1) (COST_INV) AS COST FROM  FILE7_20 INNER JOIN FILE7_20H ON FILE7_20.DOC_NO = FILE7_20H.DOC_NO WHERE (FILE7_20.ITEM = FILE1_10.ITEM) AND (FILE7_20.PRICE <> 0) AND (FILE7_20H.date <= " & DateSq(xdate2.Value) & " ) " & _
             " ORDER BY FILE7_20H.date DESC), 0) AS COST INTO          BALITEM2 FROM         FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM " & _
...
Sub DelTable()
On Error Resume Next
    con.Execute " Drop Table BALITEM2"
    Err.Clear
End Sub
