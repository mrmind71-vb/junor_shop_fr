...
temptable.Open "temp", contemp, adOpenKeyset, adLockOptimistic, adCmdTable
    ...
    cField2 = myiif("type = '2' OR type = '7' OR type = 'F' OR type = 'T'   ", "([IN] - [OUT]) * FILE1_11.COST ") & " AS T_IN , "
    cField3 = myiif("type = '6'  ", "([OUT]) ") & " AS Q_SAL , "
    cField4 = myiif("type = '6'  ", "([OUT]* FILE1_10.COST ) ") & " AS T_SAL , "
    cField5 = myiif("type = '6'  ", "([OUT]* FILE1_10.COST ) ") & " AS COST_SAL  "
...
With sourcetable
    ...
    Loop
End With
    main.Report1.ReportFileName = App.Path & "\Reports\R_BalModel.rpt"
    contemp.BeginTrans
    contemp.CommitTrans
