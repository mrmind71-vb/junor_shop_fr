...
Begin VB.Form VsTSalesmonth 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTSalesmonth.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTSalesmonth.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   135
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTSalesmonth.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   135
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTSalesmonth.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSalesmonth.frx":9583
      Height          =   8055
      Left            =   90
      TabIndex        =   1
      Top             =   1395
   ...
   End
End
Attribute VB_Name = "VsTSalesmonth"
...
'                           0               1                 2                3               4                5
    ...
    cString = " SELECT year(T_SALESDOC.date ) , month(T_SALESDOC.date) ,, count(Distinct FILE6_20H.doc_no) , " & _
            " SUM(T_SALESDOC.t_QUANT) AS t_q, SUM(T_SALESDOC.t_TOTAL - T_SALESDOC.discount )  AS t_sales, SUM(T_SALESDOC.t_cost) AS t_cost , SUM(T_SALESDOC.t_TOTAL - T_SALESDOC.discount - T_SALESDOC.t_cost )  " & _
            " FROM T_SALESDOC  WHERE doc_no  IS NOT NULL "
    ...
    cString = cString & cStr2 & " GROUP BY   year(date ) , month(date)  ORDER BY  year(date ) , month(date)  "
