...
Begin VB.Form rpcharge_BR3 
   ...
   End
End
Attribute VB_Name = "rpcharge_BR3"
...
cString = "SELECT acc_charge_BR.DATE, acc_charge_BR.DESCA as DescCharg, acc_charge_BR.VALUE, acc_charge_BR.CHARGE, acc_charge_BR.DOC_NO ,acc_charge_BR.BOX," & _
          "FILE8_51.DESCA AS DescCode,file0_50.DESCA AS BOXDESCA " & _
          " FROM acc_charge_BR  LEFT JOIN FILE8_51 ON acc_charge_BR.CHARGE = FILE8_51.CODE LEFT JOIN FILE0_50 ON acc_charge_BR.BOX = FILE0_50.CODE WHERE  VALUE <> 0  "
