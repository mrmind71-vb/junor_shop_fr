   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "okaz.frx":1734F
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "okaz.frx":1951F
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "okaz.frx":1B667
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "okaz.frx":1D82F
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "okaz.frx":1F97E
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "okaz.frx":21B5E
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "okaz.frx":23CB9
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "okaz.frx":25E75
      End
   End
...
Private Sub CMD_PRINT_Click()
    ...
    cHeader2 = "«·„Ê—œ : " & xDesca.Caption & Space(5) & "„Ê”„ : " & xMosm.text & " " & XSTORE.text
    cHeader3 = "‰”»… Œ’„ : " & xRate.text & "‰”»… „” Â·ﬂ : " & xRate2.text
    cHeader4 = "≈Ã„«·Ì «·Œ’„  : " & xTotal.Caption
    PrintGrdNew.doprint Me.grid1, 1, -3, cHeader1, cHeader2, cHeader3, cHeader4, False, True, 10
    PrintGrdNew.Show 1
End Sub
...
For i = 1 To grid1.Rows - 1
    grid1.TextMatrix(i, 4) = Val(GetDesca("select sum([in] - [out]) from file1_11 inner join file1_10 on file1_10.item = file1_11.item where ( TYPE = '2' OR TYPE = '7' ) AND file1_10.model = " & MyParn(grid1.TextMatrix(i, 0)) & " And Date < " & DateSq(xdate.text), con) & "")
    grid1.TextMatrix(i, 5) = Val(GetDesca("select sum( [out]) from file1_11 inner join file1_10 on file1_10.item = file1_11.item where TYPE = '6' AND file1_10.model = " & MyParn(grid1.TextMatrix(i, 0)) & " And Date < " & DateSq(xdate.text), con) & "")
    grid1.TextMatrix(i, 6) = Val(GetDesca("select sum([in] - [out]) from file1_11 inner join file1_10 on file1_10.item = file1_11.item where file1_10.model = " & MyParn(grid1.TextMatrix(i, 0)) & " And Date < " & DateSq(xdate.text), con) & "")
Next
CalcTotals
If Not MYVALID Then Exit Sub
...
For i = 1 To grid1.Rows - 1
    If Val(grid1.TextMatrix(i, 9)) > 0 Then
        aInsert = AddFlag(Empty, "COST", Val(grid1.TextMatrix(i, 9)))
        aInsert = AddFlag(aInsert, "COSTITEM", Val(grid1.TextMatrix(i, 9)))
    Else
        aInsert = AddFlag(Empty, "COST", Val(grid1.TextMatrix(i, 7)))
        aInsert = AddFlag(aInsert, "COSTITEM", Val(grid1.TextMatrix(i, 7)))
    End If
    If Val(grid1.TextMatrix(i, 10)) > 0 Then
        aInsert = AddFlag(aInsert, "price2", Val(grid1.TextMatrix(i, 10)))
        aInsert = AddFlag(aInsert, "price_2", Val(grid1.TextMatrix(i, 10)))
    Else
...
For i = 1 To grid1.Rows - 1
    ...
    .TextMatrix(i, 14) = Val(.TextMatrix(i, 11)) - Val(.TextMatrix(i, 12))
...
.FormatString = "„ÊœÌ·|" & "„’‰⁄|" & "—ﬁ„ „ÊœÌ·|" & "«·’‰›|" & "Ã. „‘ —Ì« |" & "Ã. „»Ì⁄« |" & "«·ﬂ„Ì…|" & "”⁄— „’‰⁄|" & "”⁄— „” Â·ﬂ|" & "„’‰⁄ »⁄œ «·Œ’„|" & "”⁄— «Êﬂ«“ÊÌ‰|" & "Ã  ﬂ·›… ﬁ»· «·Œ’„|" & "Ã  ﬂ·›… »⁄œ «·Œ’„|" & "«·›—ﬁ|" & "≈Ã„«·Ì   «·Œ’„|"
.WordWrap = True
...
cString = "SELECT FILE0_70.model,  fact.desca, file1_10h.modelfact0 ,file1_10h.desca,FILE0_70.t_in ,FILE0_70.t_out ,FILE0_70.Quant,FILE0_70.cost,FILE0_70.price,FILE0_70.cost2,file0_70.PRICE2,FILE0_70.COST_TOTAL,FILE0_70.COST_TOTAL2, ( FILE0_70.cost-FILE0_70.cost2 ) , FILE0_70.DISCOUNT,FILE0_70.ID   " & _
          " from FILE0_70 inner join file1_10h on file1_10h.model = FILE0_70.model LEFT join fact on fact.code = file1_10h.fact  "
...
Dim cString As String
cString = "SELECT FILE0_70H.*,FILE4_10.DESCA AS DESCA FROM FILE0_70H INNER JOIN FILE4_10 ON FILE0_70H.SUP = FILE4_10.CODE"
...
cString = "SELECT FILE1_10.model ,FILE1_10.COST , FILE1_10.PRICE ,file1_10.mosm ,fact.desca as factDesca,file1_10.code, file1_10.modelfact0 ,file1_10.desca , FILE1_10.COST2,FILE1_10.PRICE2,FILE1_10.RATE,Sum(FILE1_11.[IN] - FILE1_11.[out]) as Balance , " & cField1 & " , " & cField2 & _
...
cString = cString & " GROUP BY FILE1_10.COST , FILE1_10.PRICE ,FILE1_10.model ,file1_10.mosm ,fact.desca,file1_10.code , file1_10.modelfact0 ,file1_10.desca , FILE1_10.COST2,FILE1_10.PRICE2,FILE1_10.RATE"
...
With grid1
    ...
    Do Until loctable.EOF
        If loctable!T_IN <> 0 Then
        If grid1.FindRow(loctable!MODEL, , 0) = -1 Then
            grid1.AddItem ""
            i = i + 1
            prog1.Value = Round(i / (nRecordCount), 2) * 100
            grid1.TextMatrix(.Rows - 1, 0) = loctable!MODEL
            ...
            grid1.TextMatrix(.Rows - 1, 4) = loctable!T_IN & ""
            grid1.TextMatrix(.Rows - 1, 5) = loctable!T_SAL & ""
            ...
            grid1.TextMatrix(.Rows - 1, 9) = Val(loctable!costITEM & "")
            grid1.TextMatrix(.Rows - 1, 10) = Val(loctable!PRICE2 & "")
            
'            If IsNumeric(xrate.Text) Then
'                 grid1.TextMatrix(.Rows - 1, 9) = Round(Val(grid1.TextMatrix(.Rows - 1, 7)) * (1 - (Val(xrate.Text) / 100)), 2)
'            End If
'            If IsNumeric(xRate2.Text) Then
'                nRate2 = 100 - Val(xRate2.Text)
'               grid1.TextMatrix(.Rows - 1, 10) = Round(Val(grid1.TextMatrix(.Rows - 1, 8)) * nRate2, 2)
'            End If
        End If
        End If
        loctable.MoveNext
...
With grid1
    ...
    For i = 1 To .Rows - 1
        ...
        End If
        If IsNumeric(xRate2.text) Then
            nRate2 = (100 - Val(xRate2.text)) / 100
           grid1.TextMatrix(i, 10) = Round(Val(grid1.TextMatrix(i, 8)) * nRate2, 0)
        End If
    Next
    prog1.Visible = False
End With
