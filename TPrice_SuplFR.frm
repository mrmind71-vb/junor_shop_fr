...
Begin VB.Form TPrice_SuplFR 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "TPrice_SuplFR.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "TPrice_SuplFR.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "TPrice_SuplFR.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TPrice_SuplFR.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "TPrice_SuplFR.frx":9583
      Height          =   7335
      Left            =   45
      TabIndex        =   1
      Top             =   2025
   ...
   End
End
Attribute VB_Name = "TPrice_SuplFR"
...
'                           0               1                   2
    cString = " SELECT file4_10.[CODE] , file4_10.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
            ...
            " FROM FILE1_10 INNER JOIN FR1_11 ON FILE1_10.ITEM = FR1_11.ITEM LEFT JOIN file4_10 ON file4_10.CODE = FILE1_10.[code] WHERE FILE1_10.MODELNO IS NOT NULL "
