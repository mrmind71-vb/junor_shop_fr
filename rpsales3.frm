...
cString = "Select T_SAL_RET.STORE,FILE0_40.DESCA,SUM(TOTAL) AS SUMOFTOTAL,SUM(T_COST) AS SUMOFCOST  " & _
         " From  T_SAL_RET INNER JOIN FILE0_40 ON T_SAL_RET.STORE = FILE0_40.CODE "
...
cString = cString & " GROUP BY T_SAL_RET.STORE,FILE0_40.DESCA"
...
contemp.BeginTrans
contemp.CommitTrans
main.Report1.ReportFileName = App.Path & "\Reports\sales3.rpt"
