...
Begin VB.Form VsTInpit_Tab 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "’Ê—… «·„ÊœÌ·"
      TabPicture(0)   =   "VsTInpit_Tab2.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "ImgX1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "query "
      TabPicture(1)   =   "VsTInpit_Tab2.frx":001C
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1080
         Picture         =   "VsTInpit_Tab2.frx":0038
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3195
         Picture         =   "VsTInpit_Tab2.frx":2823
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "VsTInpit_Tab2.frx":4D15
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   555
         Left            =   2160
         Picture         =   "VsTInpit_Tab2.frx":7181
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   135
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "„ÊœÌ·« "
      TabPicture(0)   =   "VsTInpit_Tab2.frx":95AB
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid0"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "„’«‰⁄"
      TabPicture(1)   =   "VsTInpit_Tab2.frx":95C7
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "GRID1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   " «·√ﬁ”«„"
      TabPicture(2)   =   "VsTInpit_Tab2.frx":95E3
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "GRID2"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "«·„Ã„Ê⁄« "
      TabPicture(3)   =   "VsTInpit_Tab2.frx":95FF
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "GRID3"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   " ›∆«  ⁄„—Ì…"
      TabPicture(4)   =   "VsTInpit_Tab2.frx":961B
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "GRID4"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   " ›’Ì·Ï „Ã„⁄ - „ÊœÌ·«  - —»Õ"
      TabPicture(5)   =   "VsTInpit_Tab2.frx":9637
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "grid5"
      Tab(5).Control(0).Enabled=   0   'False
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "«·›—Ê⁄"
      TabPicture(6)   =   "VsTInpit_Tab2.frx":9653
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "GRID6"
      Tab(6).Control(0).Enabled=   0   'False
      Tab(6).ControlCount=   1
      TabCaption(7)   =   "„Ã„Ê⁄«  „ÊœÌ·« "
      TabPicture(7)   =   "VsTInpit_Tab2.frx":966F
...
With GRID5
    ...
    Else
        Set DATA15.Recordset = myCmd(cString, con)
    End If
