...
cField2 = "(Select Sum(Discount) " & _
          " from file7_20h  inner JOIN file4_10 on file7_20h.code = file4_10.code " & _
          turnFound(cWhere) & _
...
cString = "SELECT FILE7_20H.DOC_NO, FILE7_20H.DATE, FILE7_20H.CODE, FILE0_40.DESCA AS FILE0_40DESCA, FILE7_20.ITEM, FILE1_10.DESCA, FILE7_20.PRICE, FILE7_20.QUANT, FILE7_20.CHARGES, FILE7_20.CHARGE2, FILE7_20H.tax, FILE7_20H.discount, file4_10.DESCA AS FILE4_10DESCA ,FILE7_20.CHARGESDESCA, " & _
          ...
          " FROM (((FILE7_20 INNER JOIN FILE7_20H ON FILE7_20.DOC_NO = FILE7_20H.DOC_NO) LEFT JOIN FILE0_40 ON FILE7_20H.store = FILE0_40.CODE) LEFT JOIN FILE1_10 ON FILE7_20.ITEM = FILE1_10.ITEM) inner JOIN file4_10 ON FILE7_20H.code = file4_10.CODE"
...
If Trim(xCode.text) <> "" Then
    cWhere = cWhere & " AND FILE7_20h.code = " & MyParn(xCode.text)
    aHeader(2) = "[" & "··„Ê—œ : " & xCodeDesca.Caption & "]"
End If
...
If IsDate(xdate1.text) Then
    cWhere = cWhere & " AND FILE7_20H.date >= " & DateSq(xdate1.text)
    aHeader(2) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

If IsDate(xDate2.text) Then
    cWhere = cWhere & " AND FILE7_20H.date <= " & DateSq(xDate2.text)
    aHeader(2) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

If Trim(xMosm.BoundText) <> "" Then
    cWhere = cWhere & " AND FILE7_20h.mosm  = " & MyParn(xMosm.BoundText)
    aHeader(3) = "[" & "„Ê”„ : " & xMosm.text & "]"
End If

cString = "SELECT FILE7_20H.DOC_NO, FILE7_20H.DATE, FILE7_20H.CODE, FILE1_10.MODELFACT, FILE1_10.desca AS ITEMDESCA, SUM(FILE7_20.QUANT) AS T_QUANT , SUM(FILE7_20.TOTAL) AS T_TOT , FILE7_20H.TAX, FILE7_20H.DISCOUNT, FILE4_10.DESCA AS SUPPDESCA, FACT.DESCA AS FACTDESCA, FILE7_20H.INV_NO " & _
          " FROM FILE7_20 INNER JOIN FILE7_20H ON FILE7_20.DOC_NO = FILE7_20H.DOC_NO INNER JOIN FILE1_10 ON FILE7_20.ITEM = FILE1_10.ITEM INNER JOIN FILE4_10 ON FILE7_20H.CODE = FILE4_10.CODE INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE  WHERE FILE7_20H.DOC_NO IS NOT NULL "
cString = cString & cWhere & " GROUP BY FILE7_20H.DOC_NO, FILE7_20H.DATE, FILE7_20H.CODE, FILE1_10.MODELFACT, FILE1_10.desca, FILE7_20H.TAX, FILE7_20H.DISCOUNT, FILE4_10.DESCA, FACT.DESCA, FILE7_20H.INV_NO "
                                                     
sourcetable.Open cString, con, adOpenStatic, adLockReadOnly, adCmdText
Do Until sourcetable.EOF
    temptable.AddNew
    temptable!str1 = sourcetable!doc_no
    temptable!str3 = sourcetable!INV_NO
