...
Begin VB.Form VsAllTransBRANCH 
   Caption         =   "≈Ã„«·Ï ﬁÌ„… Ê ⁄œœ «·„ÊœÌ·«  ··›—Ê⁄ "
   ClientHeight    =   10230
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1230
         Picture         =   "VsAllTransBRANCH.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3600
         Picture         =   "VsAllTransBRANCH.frx":27EB
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "VsAllTransBRANCH.frx":4CDD
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   555
         Left            =   2430
         Picture         =   "VsAllTransBRANCH.frx":7149
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsAllTransBRANCH.frx":9573
      Height          =   6930
      Left            =   90
      TabIndex        =   1
      Top             =   2610
   ...
   End
End
Attribute VB_Name = "VsAllTransBRANCH"
...
Private Sub cmdPrint_Click()
    ...
    cHead1 = Me.Caption & XSTORE.text & "  " & xModelFact.text
...
'    End If
    ...
    If SEC(3).Value <> 0 Then
        cString = " SELECT  STORE_BR.CODE , STORE_BR.DESCA , ' ' AS N2 , ' ' AS N3 , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & _
                " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  INNER JOIN STORE_BR ON STORE_BR.CODE = FILE1_11_ALL.STORE WHERE file1_10.ISNOITEM = 0 "
    End If
    
    If SEC(0).Value <> 0 Then
        cString = " SELECT  STORE_BR.CODE , STORE_BR.DESCA , FILE1_10.[MOSM], FILE1_10.[MOSM] , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & _
                " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM   INNER JOIN STORE_BR ON STORE_BR.CODE = FILE1_11_ALL.STORE  WHERE file1_10.ISNOITEM = 0 "
    End If
    If SEC(1).Value <> 0 Then
        cString = " SELECT  STORE_BR.CODE , STORE_BR.DESCA, FILE1_10.MODELSEX , FILE0_81.DESCA AS factdesca , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & _
                " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  INNER JOIN STORE_BR ON STORE_BR.CODE = FILE1_11_ALL.STORE  LEFT JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX WHERE file1_10.ISNOITEM = 0 "
    End If
    If SEC(2).Value <> 0 Then
        cString = " SELECT  STORE_BR.CODE , STORE_BR.DESCA , FILE1_10.MODELAGE, FILE0_82.DESCA , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & _
...
'    If IsDate(xdate1.Value) Then cStr2 = cStr2 & " AND [DATE] >= " & DateSq(xdate1.Value)
    ...
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY STORE_BR.CODE , STORE_BR.DESCA , FILE1_10.MOSM ORDER BY STORE_BR.CODE "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY STORE_BR.CODE , STORE_BR.DESCA , FILE1_10.MODELSEX , FILE0_81.DESCA ORDER BY STORE_BR.CODE "
    End If
    If SEC(2).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY STORE_BR.CODE , STORE_BR.DESCA , FILE1_10.MODELAGE, FILE0_82.DESCA  ORDER BY STORE_BR.CODE "
    End If
    If SEC(3).Value <> 0 Then
