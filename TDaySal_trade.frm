...
Begin VB.Form TDaySal 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   510
         Left            =   90
         Picture         =   "TDaySal_trade.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   135
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_trade.frx":246C
         Caption         =   "ÿ»«⁄… «·ÌÊ„ "
         Alignment       =   4
         PictureAlignment=   10
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   450
         Left            =   90
         Picture         =   "TDaySal_trade.frx":48A6
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   225
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex7Ctl.VSFlexGrid GridBox 
         Bindings        =   "TDaySal_trade.frx":6D98
         Height          =   2985
         Left            =   90
         TabIndex        =   2
         Top             =   135
   ...
   Begin TabDlg.SSTab SSTAB 
      ...
      TabCaption(3)   =   "„»Ì⁄«  »«·”«⁄…"
      TabPicture(3)   =   "TDaySal_trade.frx":6DFF
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "GRIDHOUR"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "«·„” Âœ› «·‘Â—Ï"
      TabPicture(4)   =   "TDaySal_trade.frx":6E1B
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Frame3"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "≈Ã„«·Ï „»Ì⁄«  ÌÊ„Ï - ›—Ê⁄"
      TabPicture(5)   =   "TDaySal_trade.frx":6E37
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "GRID5"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "≈Ã„«·Ï ›Ì“«"
      TabPicture(6)   =   "TDaySal_trade.frx":6E53
      ...
      Begin Threed.SSCommand PRINT1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_trade.frx":6E6F
         Alignment       =   4
         PictureAlignment=   10
      End
      Begin Threed.SSCommand PRINT4 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_trade.frx":92A9
         Alignment       =   4
         PictureAlignment=   10
      End
      Begin VB.PictureBox Picture5 
         ...
         Height          =   2355
         Left            =   -74955
         Picture         =   "TDaySal_trade.frx":B6E3
         RightToLeft     =   -1  'True
         ScaleHeight     =   2355
         ScaleWidth      =   3210
         TabIndex        =   18
      ...
      Begin Threed.SSCommand SSCommand1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_trade.frx":EDBA
         Alignment       =   4
         PictureAlignment=   10
      End
      Begin VB.PictureBox Picture1 
         ...
         Height          =   2355
         Left            =   45
         Picture         =   "TDaySal_trade.frx":111F4
         RightToLeft     =   -1  'True
         ScaleHeight     =   2355
         ScaleWidth      =   3210
         TabIndex        =   21
...
With Grid1
    ...
    If KeyCode = 46 And cBranch = "00" And XDEL_DOC.text = "654321" And Not lServerOnLine Then
        ...
        .RemoveItem .Row
'        MYLOAD1
'        Grid1.Select 0, 7, 0, 7
'        Grid1.Sort = flexSortGenericDescending
'        Grid1.Select 2, 7, 2, 7
     End If
End With
...
If Grid1.Rows > 1 Then
    If cBranch = "00" Then
        ...
        myload6 "", GridBox.TextMatrix(GridBox.Row, 0)
