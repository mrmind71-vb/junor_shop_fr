...
Begin VB.Form TPrice_item 
   Caption         =   " ﬁÌ„ «·„ÊœÌ·«  »√”⁄«— «·„’‰⁄ Ê «· ﬂ·›… Ê «·»Ì⁄"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   13260
...
'                           0               1                 2                3               4                5
    If xall(0).Value Then
        cString = " SELECT file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca , SUM( FILE1_11.[IN] -FILE1_11.OUT) , " & _
                " MIN(FILE1_10.COST) , MIN(FILE1_10.COSTITEM) , MIN(FILE1_10.PRICE)  , " & _
                ...
                " FROM FILE1_10 INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE WHERE FILE1_10.MODELNO IS NOT NULL "
    ElseIf xall(1).Value Then
        cString = " SELECT file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
                " MIN(FILE1_10.COST) , MIN(FILE1_10.COSTITEM_FR) , MIN(FILE1_10.PRICE)  , " & _
                ...
                " FROM FILE1_10 INNER JOIN FR1_11 ON FILE1_10.ITEM = FR1_11.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE WHERE FILE1_10.MODELNO IS NOT NULL "
    Else
        cString = " SELECT file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca , SUM( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) , " & _
                " MIN(FILE1_10.COST) , MIN(FILE1_10.COSTITEM) , MIN(FILE1_10.PRICE)  , " & _
    ...
    cString = cString & cStr2 & " GROUP BY file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca  "
    DATA6.RecordSource = cString
    DATA6.Refresh
End With
FIXGRID
'If grid1.Rows > 1 Then grid1.TextMatrix(1, 4) = "«·≈Ã„«·Ï"
End Sub
Sub FIXGRID()
With GRID1
    .Cols = 12
