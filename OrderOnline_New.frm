...
Begin VB.Form OrderOnline_New 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   135
         Picture         =   "OrderOnline_New.frx":252B
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   1305
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   135
         Picture         =   "OrderOnline_New.frx":4955
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "⁄—÷"
   ...
   Begin VSFlex7Ctl.VSFlexGrid GRID2 
      Bindings        =   "OrderOnline_New.frx":6E47
      Height          =   3285
      Left            =   45
      TabIndex        =   19
      Top             =   7515
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   510
         Left            =   45
         Picture         =   "OrderOnline_New.frx":6E5B
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "OrderOnline_New.frx":92C7
      Height          =   4860
      Left            =   45
      TabIndex        =   9
      Top             =   1935
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand CMD_SEND 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "OrderOnline_New.frx":92DB
         Caption         =   " —ÕÌ· ·›« Ê—… „»Ì⁄« "
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         ...
         ShapeSize       =   1
         PictureDisabled =   "OrderOnline_New.frx":B9FE
      End
...
Private Function myreplace_Sales() As String
    ...
    con_MyShop.Execute CreateInsert(aInsert, "FILE6_20H"), nRecords
