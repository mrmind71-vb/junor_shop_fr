...
cString = "SELECT FILE4_11.CODE, FILE4_10.DESCA, FILE4_10.[GROUP], FILE4_11.MOSM , " & _
          cField1 & _
...
If xMosm.BoundText <> "" Then
    cString = cString & turnFound(cString) & " mosm = " & MyParn(xMosm.BoundText)
    aHeader(0) = "[  „Ê”„ " & xMosm.Text & "]"
End If

If IsDate(xdate1.Text) Then
    cString = cString & turnFound(cString) & " date <= " & DateSq(xdate1.Text)
    aHeader(2) = "[  Õ Ï  «—ÌŒ " & xdate1.Text & "]"
End If

cString = cString & " GROUP BY FILE4_11.CODE, FILE4_11.MOSM , FILE4_10.DESCA, FILE4_10.[GROUP]"
...
Do Until sourcetable.EOF
    If Fix(Abs(sourcetable!balance)) <> 0 Then
        ...
        temptable!STR11 = sourcetable!MOSM
