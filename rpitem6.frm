...
cString = "SELECT Sum( PURCHASENET.[IN] -  PURCHASENET.OUT ) as SumOfQuant, Sum(FLAG * TOTAL) as SumOfCost ,FILE1_10.ITEM,FILE1_10.DESCA, FILE1_10.PRICE, FILE1_50.DESCA AS FILE1_50DESCA,FILE1_10.[GROUP] " & _
...
With sourcetable
    Do Until .EOF
        ...
        temptable!STR6 = !file1_50desca
        temptable!str1 = !Item
        temptable!str2 = !DESCA
        temptable!val1 = !sumOfQuant
        temptable!val2 = !SumOfCOST
        If Val(!SumOfCOST & "") <> 0 Then temptable!val3 = !sumOfQuant / Val(!SumOfCOST & "")
