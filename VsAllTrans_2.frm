...
Begin VB.Form VsAllTrans_2 
   Caption         =   "⁄œœ ﬁÌ„… Ê«—œ Ê „»Ì⁄«  Ê —’Ìœ ··„ÊœÌ·«  ·›—⁄"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsAllTrans_2.frx":9573
      Height          =   6390
      Left            =   45
      TabIndex        =   1
      Top             =   2880
   ...
   End
End
Attribute VB_Name = "VsAllTrans_2"
...
Private Sub cmdPrint_Click()
    ...
    cHead1 = "⁄œœ ﬁÌ„… Ê«—œ Ê „»Ì⁄«  Ê —’Ìœ ··„ÊœÌ·«  ·›—⁄ " & XSTORE.text
    ...
    printGrdNew.DOPRINT GRID1, 0.8, -2, cHead1, cHead2, , , , True, 8
    printGrdNew.Show 1
End Sub
...
Private Sub myload()
Dim i As Double
Dim cWF As String, cWF2 As String
Dim cString  As String, cStr2 As String, cStrStore As String
With GRID1
    ...
    If IsDate(xdate1.Value) Then cWF = " AND DATE >= " & DateSq(xdate1.Value)
    If XSTORE.BoundText <> "" Then
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "([IN]) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "(FILE1_11_ALL.[IN] * FILE1_11_ALL.COST ) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "([OUT]) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "(FILE1_11_ALL.[OUT] * FILE1_11_ALL.COST ) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "([IN]-[OUT]) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' or type = 't' or type = 'f'  )" & cWF, "(([IN]-[OUT]) * FILE1_11_ALL.COST ) ")
    Else
        cField = cField & "," & _
                myiif("(type = '2' )" & cWF, "([IN]) ")
        
        cField = cField & "," & _
                myiif("(type = '2' )" & cWF, "(FILE1_11_ALL.[IN] * FILE1_11_ALL.COST ) ")
        
        cField = cField & "," & _
                myiif("(type = '7' )" & cWF, "([OUT]) ")
        
        cField = cField & "," & _
                myiif("(type = '7' )" & cWF, "(FILE1_11_ALL.[OUT] * FILE1_11_ALL.COST ) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' )" & cWF, "([IN]-[OUT]) ")
        
        cField = cField & "," & _
                myiif("(type = '2' or type = '7' )" & cWF, "(([IN]-[OUT]) * FILE1_11_ALL.COST ) ")
    End If
    
    cField = cField & "," & _
            myiif("type = '6' " & cWF, " [OUT] ")
    
    cField = cField & "," & _
            myiif("type = '6' " & cWF, " ([OUT]* FILE1_11_ALL.COST) ")
    
    cField = cField & "," & _
            myiif("type = '6' " & cWF, " (FILE1_11_ALL.TOTAL ) ")
    
    cField = cField & "," & _
            myiif("type = '6' " & cWF, " FILE1_11_ALL.TOTAL -([OUT]* FILE1_11_ALL.COST) ")
    
    
    cString = " SELECT  FILE4_10.DESCA AS supldesca, FACT.DESCA AS factdesca, FILE1_10.MOSM, FILE1_10.MODELFACT0, FILE1_10.desca " & _
                cField & _
            "  , SUM( [IN]-[OUT] )  , SUM(( [IN]-[OUT] )* FILE1_11_ALL.COST )  " & _
    ...
    cString = cString & cStr2 & " GROUP BY FILE4_10.CODE, FILE4_10.DESCA, FACT.DESCA, FILE1_10.MOSM, FILE1_10.MODELFACT0, FILE1_10.desca , FILE1_10.MODEL ORDER BY FILE4_10.CODE, FILE4_10.DESCA, FACT.DESCA, FILE1_10.MOSM, FILE1_10.MODELFACT0 "
