...
cString = "SELECT FILE8_71.DESCA AS DESCMAN , SUM(QFILE8_70.VALUE_M) AS T_M , SUM(QFILE8_70.VALUE_P) AS T_P FROM QFILE8_70 INNER JOIN FILE8_71 ON QFILE8_70.CODE = FILE8_71.CODE "
