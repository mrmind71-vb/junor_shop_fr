...
Begin VB.Form TPrice_SECFR 
   Caption         =   " ﬁÌ„ „ÊœÌ·«  «·«ﬁ”«„  »√”⁄«— «·„’‰⁄ Ê «· ﬂ·›… Ê «·»Ì⁄ ·· ÊﬂÌ·«  ·· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "TPrice_SecFR.frx":9583
      Height          =   7335
      Left            =   45
      TabIndex        =   1
      Top             =   2025
   ...
   End
End
Attribute VB_Name = "TPrice_SECFR"
...
'                           0               1                   2
    cString = " SELECT file1_10SC.[CODE] , file1_10SC.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
            " SUM(FILE1_10.COST * ( FR1_11.[IN] -FR1_11.OUT) ) , SUM(FILE1_10.COSTITEM * ( FR1_11.[IN] -FR1_11.OUT) ) , SUM(FILE1_10.PRICE * ( FR1_11.[IN] -FR1_11.OUT) )  " & _
    ...
    If IsDate(XDATE2.Value) Then cStr2 = cStr2 & " AND FR1_11.date  <= " & DateSq(XDATE2.Value)
