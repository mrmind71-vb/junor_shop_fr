...
cField13 = myiif(cWhere & turn(cWhere, " AND ") & "TYPE = '6'", "Round([OUT] * FR1_11.PRICE,0)") & " AS SALES_PRICE"
...
'           0               1               2               3           4         5         6
cField = cField1 & "," & cField2 & "," & cField3 & "," & cField4 & ", ' ' " & ", ' ' , ' ' " & _
         "," & " ' ' " & "," & " ' ' " & "," & " ' ' " & "," & cField11 & "," & cField12 & "," & cField13 & "," & cField14 & _
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 15) = "„»Ì⁄« "
    .TextMatrix(1, 12) = "⁄œœ"
    .TextMatrix(1, 13) = "ﬁÌ„…  ﬂ·›…"
    .TextMatrix(1, 14) = "ﬁÌ„… »Ì⁄"
    .TextMatrix(1, 15) = "—»Õ"

    .TextMatrix(0, 16) = "—’Ìœ Õ«·Ì"
    .TextMatrix(0, 17) = "—’Ìœ Õ«·Ì"
    .TextMatrix(1, 16) = "⁄œœ"
    .TextMatrix(1, 17) = "ﬁÌ„…"
