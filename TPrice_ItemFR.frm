...
Begin VB.Form TPrice_itemFR 
   Caption         =   " ﬁÌ„ «·„ÊœÌ·«  »√”⁄«— «·„’‰⁄ Ê «· ﬂ·›… Ê «·»Ì⁄ ·· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "TPrice_ItemFR.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "TPrice_ItemFR.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "TPrice_ItemFR.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TPrice_ItemFR.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "TPrice_ItemFR.frx":9583
      Height          =   7335
      Left            =   45
      TabIndex        =   1
      Top             =   2025
   ...
   End
End
Attribute VB_Name = "TPrice_itemFR"
...
'                           0               1                 2                3               4                5
    ...
    If IsDate(XDATE2.Value) Then cStr2 = cStr2 & " AND FILE1_11.date  <= " & DateSq(XDATE2.Value)
...
With grid1
    ...
    .ColHidden(0) = True
    .ColHidden(6) = Not bopt2
    .ColHidden(7) = Not bopt2
    .ColHidden(9) = Not bopt2
    .ColHidden(10) = Not bopt2
