...
Begin VB.Form VsTSales_price2 
   Caption         =   "≈Ã„«·Ï „ÊœÌ·«  ⁄œœ & ”⁄— „” Â·ﬂ & «·ﬁÌ„… »”⁄— «·»Ì⁄"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin VB.Frame Frame3 
      ...
      Begin ImgXCtrl6.ImgXCtrl ImgX1 
         ...
         LicenseRegCode  =   "íß“∂∫©æºµ≠¶“™Ωπß≥´¨©MOCG-EEUEXNJU-EQTP6gI"
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton CMD_PRINT 
            Height          =   465
            Left            =   1260
            Picture         =   "VsTSales_price2.frx":0000
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   27
            Top             =   135
         ...
         Begin VB.CommandButton cmdExit 
            Height          =   465
            Left            =   45
            Picture         =   "VsTSales_price2.frx":242A
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   26
            Top             =   135
         ...
         Begin VB.CommandButton cmdGo 
            Height          =   465
            Left            =   2475
            Picture         =   "VsTSales_price2.frx":4896
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   25
            ToolTipText     =   "⁄—÷"
         ...
         Begin Threed.SSCommand cmd_excel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "VsTSales_price2.frx":6D88
            Caption         =   " ÕÊÌ· «ﬂ”Ì· "
            Alignment       =   4
            PictureAlignment=   1
         End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSales_price2.frx":9583
      Height          =   6525
      Left            =   45
      TabIndex        =   1
      Top             =   2925
   ...
   End
End
Attribute VB_Name = "VsTSales_price2"
...
'    data10.RecordSource = "Select Code,DescA From File3_50 order by Desca"
'    Set xgrcust.RowSource = data10
'    xgrcust.ListField = "Desca"
'    xgrcust.BoundColumn = "Code"
...
'                           0               1                 2                3               4                5
    ...
    cString = cString & " ' ' AS N1 , FACT.desca , file1_10.ModelNo , file1_10.mosm , file1_10.MODELFACT0, file1_10.desca ,   " & _
            " SUM(FILE6_20.QUANT) AS t_q, SUM(FILE6_20.TOTAL * ((100-FILE6_20H.RATE )/100)) AS t_sales, SUM(FILE6_20.QUANT * FILE6_20.cost) AS t_cost, SUM((FILE6_20.TOTAL * ((100-FILE6_20H.RATE )/100))  - (FILE6_20.QUANT * FILE6_20.cost)) AS t_proft " & _
            " FROM FILE1_10 INNER JOIN FILE6_20 ON FILE1_10.ITEM = FILE6_20.ITEM INNER JOIN FILE6_20H ON FILE6_20.DOC_NO = FILE6_20H.DOC_NO INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE inner join file4_10 on file4_10.code = file1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
    If xcust.BoundText <> "" Then cStr2 = cStr2 & " AND FILE6_20h.code = " & MyParn(xcust.BoundText)
    ...
    If xdoc_no.Text <> "" Then cStr2 = cStr2 & " AND FILE6_20.doc_no = " & MyParn(xdoc_no.Text)
    ...
    If IsDate(xDate1.Text) Then cStr2 = cStr2 & " AND FILE6_20h.[DATE] >= " & DateSq(xDate1.Text)
    If IsDate(xdate2.Text) Then cStr2 = cStr2 & " AND FILE6_20h.[DATE] <= " & DateSq(xdate2.Text)
