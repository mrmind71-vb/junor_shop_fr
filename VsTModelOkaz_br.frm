...
Begin VB.Form VsTModelOkaz_br 
   Caption         =   "≈Ã„«·Ï „»Ì⁄«  & Œ’„ «Êﬂ«“ÊÌ‰ ··„ÊœÌ·«   - ⁄—Ê÷"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton CMD_PRINT 
            Height          =   465
            Left            =   1260
            Picture         =   "VsTModelOkaz_br.frx":0000
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   25
            Top             =   135
         ...
         Begin VB.CommandButton cmdExit 
            Height          =   465
            Left            =   45
            Picture         =   "VsTModelOkaz_br.frx":242A
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   24
            Top             =   135
         ...
         Begin VB.CommandButton cmdGo 
            Height          =   465
            Left            =   2475
            Picture         =   "VsTModelOkaz_br.frx":4896
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   23
            ToolTipText     =   "⁄—÷"
         ...
         Begin Threed.SSCommand cmd_excel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "VsTModelOkaz_br.frx":6D88
            Caption         =   " ÕÊÌ· «ﬂ”Ì· "
            Alignment       =   4
            PictureAlignment=   1
         End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTModelOkaz_br.frx":9583
      Height          =   6615
      Left            =   45
      TabIndex        =   1
      Top             =   2790
   ...
   End
End
Attribute VB_Name = "VsTModelOkaz_br"
...
With GRID1
'                           0               1                 2                3               4                5
'and ( QFILE6_20.username_disc IS NULL OR QFILE6_20.username_disc = '' )
    cString = "SELECT  QBRANCH_ALL.CODE , QBRANCH_ALL.desca , " & _
            " SUM(QFILE6_20.QUANT) , SUM(QFILE6_20.QUANT * QFILE6_20.price_c ) , sum((QFILE6_20.QUANT * QFILE6_20.price_c )-QFILE6_20.total )  " & _
            " , SUM( CASE WHEN ( QFILE6_20.username_disc IS NULL OR QFILE6_20.username_disc = '' ) THEN   QFILE6_20.TOTAL * (((QFILE6_20.RATE)/100)) ELSE 0 END ) " & _
            ", SUM( CASE WHEN ( username_disc IS NOT NULL  AND username_disc <> '') THEN   QFILE6_20.TOTAL * (((QFILE6_20.RATE)/100)) ELSE 0 END ) " & _
            ", 0 , SUM( QFILE6_20.TOTAL * (((100-QFILE6_20.RATE)/100)))" & _
            " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM INNER JOIN QBRANCH_ALL ON QFILE6_20.STORE = QBRANCH_ALL.STORE WHERE QBRANCH_ALL.CODE  IS NOT NULL "
    ...
    cString = cString & cStr2 & " GROUP BY QBRANCH_ALL.CODE , QBRANCH_ALL.desca ORDER BY QBRANCH_ALL.CODE  "
...
With GRID1
    ...
    .TextMatrix(0, 2) = "⁄œœ „»Ì⁄« "
    .TextMatrix(0, 3) = "«·ﬁÌ„… »”⁄— «·„” Â·ﬂ"
    .TextMatrix(0, 4) = "Œ’„ «Êﬂ«“ÊÌ‰"
    .TextMatrix(0, 5) = "Œ’„ ⁄—÷ "
    .TextMatrix(0, 6) = "Œ’„ √Œ—"
    .TextMatrix(0, 7) = "≈Ã„«·Ï Œ’„"
    .TextMatrix(0, 8) = "ﬁÌ„… „»Ì⁄« "
    .TextMatrix(0, 9) = "‰”»… Œ’„"
    ...
    For nRow = 1 To .Rows - 1
        nRate = 0
        .TextMatrix(nRow, 7) = Val(.TextMatrix(nRow, 4)) + Val(.TextMatrix(nRow, 5)) + Val(.TextMatrix(nRow, 6))
        NTDIS = Val(.TextMatrix(nRow, 7))
        If Val(.TextMatrix(nRow, 3)) <> 0 Then nRate = Round(NTDIS / Val(.TextMatrix(nRow, 3)) * 100, 2)
        .TextMatrix(nRow, 9) = nRate
    Next nRow
