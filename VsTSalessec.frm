...
'   If XSEC.Text <> "" Then cHead3 = cHead3 & " ﬁ”„ " & XSEC.Text
    ...
    Load PrintGrd
    PrintGrd.DOPRINT GRID1, 1.2, , cHead1, cHead2, cHead3, , False, 12
    PrintGrd.Show 1
End Sub
...
'                           0               1                 2                3               4                5
    ...
    If SEC(1).Value <> 0 Then
        cString = " SELECT FILE1_10.[SECTION] , ' ' as n2 , FILE0_81.desca ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100))  - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM inner join file0_81 on file0_81.code = file1_10.modelsex where FILE1_10.MODELNO IS NOT NULL "
    End If
    
    If SEC(2).Value <> 0 Then
        cString = " SELECT FILE1_10.[SECTION] , ' ' as n2 , FILE0_82.desca ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100))  - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM inner join file0_82 on file0_82.code = file1_10.modelage where FILE1_10.MODELNO IS NOT NULL "
    End If
