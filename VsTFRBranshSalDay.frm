...
Begin VB.Form VsTFRBranshSalDay 
   Caption         =   "„ﬁ«—‰… „»Ì⁄«  ÌÊ„Ï ·· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTFRBranshSalDay.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTFRBranshSalDay.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTFRBranshSalDay.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTFRBranshSalDay.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTFRBranshSalDay.frx":9583
      Height          =   7380
      Left            =   135
      TabIndex        =   1
      Top             =   1890
   ...
   End
End
Attribute VB_Name = "VsTFRBranshSalDay"
...
With GRID1
'                           0               1                 2                3               4                        5
    cStrall = " SELECT     [DATE] , ' ' AS SUPPDESCA, SUM(QUANT) , SUM(TOTAL * ((100-RATE)/100))  , " & _
                cField2 & _
