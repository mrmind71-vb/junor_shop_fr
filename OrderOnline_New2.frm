...
Begin VB.Form OrderOnline_New 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "OrderOnline_New2.frx":0000
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ShapeSize       =   1
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   135
         Picture         =   "OrderOnline_New2.frx":252B
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   1305
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   135
         Picture         =   "OrderOnline_New2.frx":4955
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "⁄—÷"
   ...
   Begin VSFlex7Ctl.VSFlexGrid GRID2 
      Bindings        =   "OrderOnline_New2.frx":6E47
      Height          =   3285
      Left            =   45
      TabIndex        =   19
      Top             =   7515
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "OrderOnline_New2.frx":6E5B
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "OrderOnline_New2.frx":92C7
      Height          =   4860
      Left            =   45
      TabIndex        =   9
      Top             =   1935
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand CMD_SEND 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "OrderOnline_New2.frx":92DB
         Caption         =   " —ÕÌ· ·›« Ê—… „»Ì⁄« "
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         ...
         ShapeSize       =   1
         PictureDisabled =   "OrderOnline_New2.frx":B9FE
      End
...
'    On Error GoTo myerror
    ...
    Set data5.Recordset = myCmd("SELECT CODE,DESCA FROM FILE6_25 WHERE FILE6_25.BRANCH IN (SELECT FILE0_40.BRANCH FROM FILE0_40 WHERE FILE0_40.online =  1) AND FILE6_25.ISSTOP = 0 ORDER BY CODE ", con_SERVER)
    ...
    CLIST = StrListA("SELECT CODE , DESCA FROM FILE0_40 WHERE ONLINE = 1 ORDER BY CODE ", con_SERVER)
    LoadText Me
    Exit Sub
myerror:
...
With grid1
    ...
    Set data1.Recordset = myCmd(cString, con_SERVER)
...
With grid1
    If Col = 23 + 1 Then
        con_SERVER.Execute " UPDATE FILE6_90H SET [NOTE_BRANCH] = " & addstring(.TextMatrix(Row, Col)) & " WHERE DOC_NO = " & MyParn(.TextMatrix(Row, 0))
    End If
    ...
    Select Case Col
        ...
        Case 19
            con_SERVER.Execute " UPDATE FILE6_90H SET [SHIP_DATE] = " & addDate(.TextMatrix(Row, Col)) & " WHERE DOC_NO = " & MyParn(.TextMatrix(Row, 0))
        Case 22 + 1
            con_SERVER.Execute " UPDATE FILE6_90H SET [NOTE_MAIN] = " & addstring(.TextMatrix(Row, Col)) & " WHERE DOC_NO = " & MyParn(.TextMatrix(Row, 0))
    End Select
End With
End Sub
...
With grid1
    ...
    ElseIf Col = 19 + 1 And .TextMatrix(Row, 12) <> "" Then
        If MsgBox(" «·€«¡ «·ÿ·»Ì… „‰ «·⁄„Ì· ", vbYesNo + vbDefaultButton2) = vbYes Then
            ...
            con_SERVER.Execute " UPDATE FILE6_90H SET store = null, DelOrder_Date = " & DateSq(Date) & "  , NOTES = " & addstring(cNoteS) & " WHERE DOC_NO = " & MyParn(.TextMatrix(Row, 0))
            .TextMatrix(Row, 12) = ""
        Else
            cNoteS = ""
            .TextMatrix(Row, 19 + 1) = ""
...
ElseIf ActiveControl.Name = grid1.Name And grid1.Col = 24 + 1 Then
    ...
    Else
        ...
        con_SERVER.Execute " UPDATE FILE6_90H SET [Man] = " & addstring(grid1.TextMatrix(grid1.Row, 25 + 1)) & " WHERE DOC_NO = " & MyParn(grid1.TextMatrix(grid1.Row, 0))
        oSearchMan.Hide
...
SourchTable.Open cString.GetAsString(), con_SERVER, adOpenStatic, adLockReadOnly, adCmdText
                        ...
                        For nCol = 2 To 90
                            ...
                            Case "Email"
                                ...
                                Case "Shipping Address1"
                                    ...
                                    aInsert = AddFlag(aInsert, "Address1", addstring(cAddress1))
                                Case "Shipping Address2"
                                    cAddress2 = Trim(xlsheet.Cells(nR - ow, nCol))
                                    cAddress2 = Replace(cAddress1, "'", " ")
                                    aInsert = AddFlag(aInsert, "Address2", addstring(cAddress2))
                                Case "Shipping City"
                                    cCity = Trim(xlsheet.Cells(nRow, nCol))
...
For i = 1 To cSv.NumRows - 1
    ...
    If Trim(cSv.GetCellByName(i, "Name")) Then
        If cSv.GetCellByName(i, "Name") <> sName Then
            sName = cSv.GetCellByName(i, "Name")
            
            Tb.Append "SELECT " & MyParn(Replace(cSv.GetCellByName(i, "Name"), "#", "")) & " AS ITEM,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Email"), "") & " AS EMAIL,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Shipping"), "") & " AS Shipping,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Total"), "") & " AS Total,"
            
            Tb.Append MyParn(cSv.GetCellByName(i, "Subtotal"), "") & " AS Subtotal,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Subtotal"), "") & " AS Subtotal,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Subtotal"), "") & " AS Subtotal,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Subtotal"), "") & " AS Subtotal,"
            Tb.Append MyParn(cSv.GetCellByName(i, "Subtotal"), "") & " AS Subtotal,"
