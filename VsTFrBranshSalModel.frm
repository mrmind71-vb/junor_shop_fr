...
Begin VB.Form VsTfrBranshSalModel 
   Caption         =   "≈Ã„«·Ï „‘ —Ì«  & —„»Ì⁄«  & —’Ìœ «·„ÊœÌ·«  ·· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   13260
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTFrBranshSalModel.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTFrBranshSalModel.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTFrBranshSalModel.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTFrBranshSalModel.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTFrBranshSalModel.frx":9583
      Height          =   7380
      Left            =   135
      TabIndex        =   1
      Top             =   1845
   ...
   End
End
Attribute VB_Name = "VsTfrBranshSalModel"
...
cWhere = "  (FR1_11.TYPE = '2' OR FR1_11.TYPE = '7'   ) "
cField3 = myiif(cWhere, "[IN]-[OUT]")

cWhere = "  (FR1_11.TYPE = '6'   ) "
...
'    .FixedRows = 2
    ...
    For nCol = 6 To .Cols - 4 Step 4
        .TextMatrix(1, nCol) = "„‘ —Ì« "
        .TextMatrix(1, nCol + 1) = "„»Ì⁄« "
        .TextMatrix(1, nCol + 2) = "—’Ìœ"
        .TextMatrix(1, nCol + 3) = "‰”»…"
        
        .TextMatrix(0, nCol) = GetDesca("SELECT DESCA FROM dbo.BRANCH_FR WHERE CODE = " & MyParn(.TextMatrix(0, nCol)), con)
    ...
    .TextMatrix(0, .Cols - 4) = "≈Ã„«·Ï «· ÊﬂÌ·« "
    .TextMatrix(0, .Cols - 3) = "≈Ã„«·Ï «· ÊﬂÌ·« "
    .TextMatrix(0, .Cols - 3) = "≈Ã„«·Ï «· ÊﬂÌ·« "
    .TextMatrix(0, .Cols - 1) = "≈Ã„«·Ï «· ÊﬂÌ·« "
    
    .TextMatrix(1, .Cols - 4) = "Ã „‘ —Ì« "
    .TextMatrix(1, .Cols - 3) = "Ã „»Ì⁄« "
    .TextMatrix(1, .Cols - 2) = "Ã «·—’Ìœ"
    .TextMatrix(1, .Cols - 1) = "Ã ‰”»…"
    ...
    For nCol = 8 To .Cols - 2 Step 4
        For nRow = 1 To .Rows - 1
            If Val(.TextMatrix(nRow, nCol - 2)) <> 0 Then
                .TextMatrix(nRow, nCol + 1) = Round(Val(.TextMatrix(nRow, nCol - 1)) / Val(.TextMatrix(nRow, nCol - 2)) * 100, 2)
            End If
        Next nRow
        .Cell(flexcpBackColor, 0, nCol, .Rows - 1, nCol) = vbGreen
        .Cell(flexcpBackColor, 0, nCol + 1, .Rows - 1, nCol + 1) = vbYellow
    Next nCol
