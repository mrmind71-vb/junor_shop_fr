...
Begin VB.Form printGrd_abd 
   ...
   End
End
Attribute VB_Name = "printGrd_abd"
...
nRow = 0
For i = 0 To grid1.FixedRows - 1
    If Not grid1.RowHidden(i) Then
        .TableCell(tcFontBold, nRow, 1, nRow, Vp.TableCell(tcCols)) = taCenterMiddle
        .TableCell(tcAlign, nRow, 1, nRow, Vp.TableCell(tcCols)) = taCenterMiddle
        .TableCell(tcBackColor, nRow, 1, nRow, Vp.TableCell(tcCols)) = &H8000000F
         MergeHeader nRow
         nRow = nRow + 1
    End If
Next
...
'If Not IsMissing(aRowHeader) Then
'    For i = 0 To UBound(aRowHeader)
'        nRowMerge = aRowHeader(i)
'    Next
'End If
...
End With
End Sub
Private Sub MergeHeader(nRow As Long)
...
If retFlag(aGrid, "left") Then
    .TextBox "Date : " & Format(Date, "YYYY-MM-DD"), Vp.PageWidth - (4000 + 1000), 600, 4000, 1000
Else
    .TextBox "«· «—ÌŒ : " & Format(Date, "YYYY-MM-DD"), Vp.PageWidth - (4000 + 1000), 600, 4000, 1000
End If
