...
Begin VB.Form VsTSaleMODEL_YEAR 
   Caption         =   "„ﬁ«—‰… „»Ì⁄«  „ÊœÌ·«  ·”‰Ê« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTSaleMODEL_YEAR.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTSaleMODEL_YEAR.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTSaleMODEL_YEAR.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTSaleMODEL_YEAR.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSaleMODEL_YEAR.frx":9583
      Height          =   7380
      Left            =   90
      TabIndex        =   1
      Top             =   2160
   ...
   End
End
Attribute VB_Name = "VsTSaleMODEL_YEAR"
...
With GRID1
'                           0               1                 2                3               4                5
        cString = " SELECT FILE1_10.MODELFACT0 , FILE1_10.DESCA  , FILE1_10.MOSM "
    ...
    If XMODEL.text <> "" Then cStr2 = cStr2 & " AND FILE1_10.modelno = " & MyParn(XMODEL.text)
    ...
    cString = cString & cStr2 & " GROUP BY FILE1_10.MODELFACT0 , FILE1_10.DESCA  , FILE1_10.MOSM ORDER BY FILE1_10.MODELFACT0 , FILE1_10.DESCA  , FILE1_10.MOSM "
...
If ActiveControl.Name = xFact.Name Then
    ...
    Unload Search3
End If
If ActiveControl.Name = XMODEL.Name Then
    ActiveControl.text = oSearchItem.GRID1.TextMatrix(oSearchItem.GRID1.Row, 0)
    xdesca.Caption = oSearchItem.GRID1.TextMatrix(oSearchItem.GRID1.Row, 1) & " / " & oSearchItem.GRID1.TextMatrix(oSearchItem.GRID1.Row, 2) & " / " & oSearchItem.GRID1.TextMatrix(oSearchItem.GRID1.Row, 4)
    oSearchItem.Hide
End If
