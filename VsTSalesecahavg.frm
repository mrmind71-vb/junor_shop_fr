...
Begin VB.Form VsTSalesecahavg 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTSalesecahavg.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTSalesecahavg.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTSalesecahavg.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTSalesecahavg.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSalesecahavg.frx":9583
      Height          =   7875
      Left            =   90
      TabIndex        =   1
      Top             =   1485
   ...
   End
End
Attribute VB_Name = "VsTSalesecahavg"
...
With GRID1
'                           0               1                 2                3               4                5
    cString = " SELECT file1_10sc.code , file1_10sc.desca , " & _
            " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, COUNT(DISTINCT QFILE6_20.DOC_NO) " & _
            " FROM QFILE6_20 INNER JOIN file1_10sc ON qFILE6_20.[section] = file1_10sc.code WHERE QFILE6_20.doc_no IS NOT NULL "
