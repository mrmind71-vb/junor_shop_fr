...
Begin VB.Form VsTSales_DOC 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSales_DOC.frx":9583
      Height          =   7470
      Left            =   90
      TabIndex        =   1
      Top             =   1260
   ...
   End
End
Attribute VB_Name = "VsTSales_DOC"
...
Private Sub CMD_PRINT_Click()
    ...
    cHead1 = Me.Caption & XSTORE.Text & " " & XMAN.Text
    cHead2 = " „‰  «—ÌŒ " & Format(xdate1.Value, "DD-MM-YYYY") & " Õ Ï  «—ÌŒ " & Format(XDATE2.Value, "DD-MM-YYYY")
    cHead3 = ""
    
    PrintGrdNew.doprint grid1, 1, -2, cHead1, cHead2, , , , True, 10
    PrintGrdNew.Show 1
End Sub
...
Private Sub Form_Load()
    ...
    data1.RecordSource = "Select Code,DescA From File6_25 ORDER BY DESCA "
...
Dim cw As String
    ...
    cString = "SELECT FILE6_20H.DOC_NO2 ,FILE6_20H.date ,FILE6_20H.TIME, FILE0_40.DESCA , SUM(FILE6_20.QUANT) , SUM(FILE6_20.TOTAL) ,FILE6_20H.discount ,FILE6_20H.TAX , SUM(FILE6_20.TOTAL) - FILE6_20H.discount + FILE6_20H.TAX , (FILE6_20H.CASH + FILE6_20H.CASH2),FILE6_20H.VISA , LATE+NOTPAY, file3_10.desca FROM (FILE6_20H INNER JOIN FILE6_20 ON FILE6_20H.DOC_NO = FILE6_20.DOC_NO) LEFT JOIN FILE0_40 ON FILE6_20H.STORE = FILE0_40.CODE inner join file3_10 on file3_10.code = file6_20h.code "
    If IsDate(xdate1.Value) Then cString = cString & turn(cString) & "DATE >= " & DateSq(xdate1.Value)
    ...
    cString = cString & " GROUP BY " & "FILE6_20H.DOC_NO,FILE6_20H.DOC_NO2,FILE6_20H.date,FILE6_20H.TIME,FILE0_40.DESCA,FILE6_20H.DISCOUNT,FILE6_20H.TAX ,FILE6_20H.CASH,FILE6_20H.VISA, LATE+NOTPAY , file3_10.desca , CASH2 "
    cString = cString & " ORDER BY DATE , FILE6_20H.DOC_NO2"
...
For nRow = 1 To .Rows - 2
    ...
    .TextMatrix(nRow, 2) = Format(TimeValue(.TextMatrix(nRow, 2)), "SHORT TIME")
    .TextMatrix(nRow, 11) = Val(.TextMatrix(nRow, 8)) - Val(.TextMatrix(nRow, 9)) - Val(.TextMatrix(nRow, 10))
Next nRow
