...
Begin VB.Form VsTSalesSUPL 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSalesSUPL.frx":9583
      Height          =   7470
      Left            =   90
      TabIndex        =   1
      Top             =   1980
   ...
   End
End
Attribute VB_Name = "VsTSalesSUPL"
...
Private Sub CMD_PRINT_Click()
    ...
    cHead1 = "≈Ã„«·Ï „»Ì⁄«  „Ê—œÌ‰ " & xStore.text & "  " & xGrCust.text
...
'                           0               1                 2                3               4                5
    ...
    If SEC(1).Value <> 0 Then
        cString = " SELECT FILE4_10.[GROUP] , FILE4_10.desca , file0_81.DESCA ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM INNER JOIN FILE4_10 ON FILE1_10.CODE = FILE4_10.CODE LEFT JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    If SEC(2).Value <> 0 Then
        cString = " SELECT FILE4_10.[GROUP] , FILE4_10.desca , file0_82.DESCA ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM INNER JOIN FILE4_10 ON FILE1_10.CODE = FILE4_10.CODE LEFT JOIN FILE0_82 ON FILE0_82.CODE = FILE1_10.MODELAGE WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
...
'                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM INNER JOIN FILE4_10 ON FILE1_10.CODE = FILE4_10.CODE WHERE FILE1_10.MODELNO IS NOT NULL "
    ...
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.[GROUP] , FILE4_10.CODE,FILE4_10.DESCA , file1_10.mosm ORDER BY FILE4_10.[GROUP], FILE4_10.CODE  "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.[GROUP] , FILE4_10.CODE, FILE4_10.desca , file0_81.DESCA ORDER BY FILE4_10.[GROUP], FILE4_10.CODE  "
    End If
    If SEC(2).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.[GROUP] , FILE4_10.CODE, FILE4_10.desca , file0_82.DESCA ORDER BY FILE4_10.[GROUP], FILE4_10.CODE  "
    End If
    If SEC(3).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.[GROUP] , FILE4_10.CODE, FILE4_10.desca ORDER BY FILE4_10.[GROUP], FILE4_10.CODE  "
    End If
