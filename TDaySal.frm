...
Begin VB.Form TDaySal 
   ...
   Begin TabDlg.SSTab SSTAB 
      ...
      TabPicture(0)   =   "TDaySal.frx":6DAB
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Grid1"
      Tab(0).Control(1)=   "PRINT1"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "≈Ã„«·Ì „»Ì⁄«  «·«’‰«›"
      TabPicture(1)   =   "TDaySal.frx":6DC7
