...
Begin VB.Form VsTitemShop_itembr 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2610
         Picture         =   "VsTitemShop_item_br.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   35
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   90
         Picture         =   "VsTitemShop_item_br.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   180
      ...
      Begin VB.CommandButton cmd_Print 
         Height          =   465
         Left            =   1305
         Picture         =   "VsTitemShop_item_br.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   33
         Top             =   180
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTitemShop_item_br.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTitemShop_item_br.frx":9583
      Height          =   6285
      Left            =   45
      TabIndex        =   2
      Top             =   3420
   ...
   End
End
Attribute VB_Name = "VsTitemShop_itembr"
...
'    cBalOrder = ",(SELECT SUM(BALITEM) FROM [BAL_ITEM_ORDERONLINE] WHERE [BAL_ITEM_ORDERONLINE].ITEM = FILE1_10.ITEM  AND [BAL_ITEM_ORDERONLINE].STORE = " & MyParn(XSTORE.BoundText) & ")"
    If Check2.Value <> 0 Then
        ...
        cFDem4 = " , ( SELECT TOP 1 DATE    FROM FR1_11 AS FR1_11_2 WHERE FR1_11_2.item = FILE1_10.item AND FR1_11_2.STORE = " & MyParn(XSTORE.BoundText) & " AND ( TYPE = '2' OR TYPE = 'T' )  ORDER BY DATE DESC ) "
    ...
    cField5 = myiif("type = 'z' and FR1_11.date >= " & DateSq(xdate1.text) & cStore, "([in] + [out]) ") & " AS t_comp , "
    cField6 = myiif("(type = '2' OR type = 'F' OR type = 'T'  ) and FR1_11.date >= " & DateSq(xdate1.text) & cStore, "([IN] ) ") & " AS t_purch, "
    cField7 = myiif("(type = '7' OR type = 'F' OR type = 'T'  ) and FR1_11.date >= " & DateSq(xdate1.text) & cStore, "(OUT  ) ") & " AS tR_purch, "
    cField8 = myiif("type = '6' and FR1_11.date >= " & DateSq(xdate1.text) & cStore, "([out] - [in]) ") & " AS t_sal  , "
    
    
    cField10 = myiif("FR1_11.STORE = " & MyParn(XSTORE.BoundText), "( [IN]-[out] ) ") & " AS BAL , "
'    cField11 = myiif("FR1_11.STORE = " & MyParn(XSTORE.BoundText), " (([IN]-[out] ) * file1_10.costITEM  )") & " AS VALBAL  "
    cField11 = " 0 "
    '                   0                   1                  2               3            4                              5
    ...
    cString = " SELECT  FACT.desca , file1_10.mosm, file1_10.modelfact0 , file1_10.desca ,file1_10.scal , file1_10.color , file1_10.item  , " & _
            ...
            cField10 & _
            " ' ' as rate , min(file1_10.price) , 0  , 0 " & cFDem1 & cFDem2 & cFDem3 & cFDem4 & " , ' ' AS N21 , MOSM2 , FILE1_10.ISNODEM " & CFDEM5 & _
    ...
    End If
    cString = cString & cStr2 & " GROUP BY file1_10.item , file1_10.scal , file1_10.color  , FILE1_10.REDEM , FACT.desca , file1_10.mosm, file1_10.modelfact0 , file1_10.desca  , file1_10.[section] , OKAZ , ISNODEM , MOSM2 "
    cStrH = ""
    ...
    If XNOSAL.Value = -1 Then
        ...
        cStrH = cStrH & " AND SUM(CASE WHEN TYPE = '6' AND FR1_11.STORE = " & MyParn(XSTORE.BoundText) & " THEN FR1_11.OUT ELSE 0 END )  = 0"
    End If
    If XISSAL.Value = -1 Then
        cStrH = " HAVING (SUM(FR1_11.[IN] - FR1_11.OUT) <> 0)"
        cStrH = cStrH & " AND SUM(CASE WHEN TYPE = '6' AND STORE = " & MyParn(XSTORE.BoundText) & " THEN FR1_11.OUT ELSE 0 END )  <> 0"
    End If
    ...
    If .col = 17 Then
        If Val(.TextMatrix(Row, 17)) <> 0 Then
            If GetDesca("SELECT ITEM FROM model_dem WHERE STORE = " & MyParn(XSTORE.BoundText) & " AND  ITEM = " & Val(nItem), con) = "" Then
                con.Execute " INSERT INTO model_dem (MODELNO , ITEM ,  STORE , QUANT , [date] ) VALUES ( " & addstring(pModelNo) & ", " & nItem & ", " & addstring(XSTORE.BoundText) & ", " & Val(.TextMatrix(Row, 17)) & "  , " & addDate(Date) & " ) "
            Else
                con.Execute "  UPDATE model_dem SET QUANT = " & Val(.TextMatrix(Row, 17)) & " , ISNEW = 1 , DATE = " & addDate(Date) & "  WHERE ITEM = " & nItem & " AND STORE = " & MyParn(XSTORE.BoundText)
            End If
        Else
...
'    If grid1.Col = 2 Then
'        aRet = aGetDesca("SELECT MODELNO , SCAL , COLOR FROM FILE1_10 WHERE ITEM = " & Val(grid1.TextMatrix(grid1.Row, 6)))
'        Load ModelMove_FR
'        ModelMove_FR.xDate.Text = xdate1.Text
'        ModelMove_FR.xModel.Text = aRet(1)
'        ModelMove_FR.xScal.Text = aRet(2)
'        ModelMove_FR.xColor.Text = aRet(3)
'
...
Else
    ...
    If XALLNEW.Value <> 0 Then con.Execute " UPDATE model_dem SET ISNEW = 1 WHERE DATE  > (SELECT MAX(DATE) FROM FR1_11 WHERE FR1_11.ITEM = model_dem.ITEM AND ( TYPE = '2' OR TYPE = 'T' ))"
