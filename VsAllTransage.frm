...
Begin VB.Form VsAllTransage 
   Caption         =   "≈Ã„«·Ï ﬁÌ„… Ê ⁄œœ ·„ÊœÌ·«  «·›∆… «·⁄„—Ì… «·Ê«—œ… ··›—⁄"
   ClientHeight    =   10230
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1230
         Picture         =   "VsAllTransage.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3600
         Picture         =   "VsAllTransage.frx":27EB
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "VsAllTransage.frx":4CDD
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   555
         Left            =   2430
         Picture         =   "VsAllTransage.frx":7149
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsAllTransage.frx":9573
      Height          =   7290
      Left            =   90
      TabIndex        =   1
      Top             =   2250
   ...
   End
End
Attribute VB_Name = "VsAllTransage"
...
'                           0               1                 2                3               4                5
    ...
    If XMOSM2.text <> "W" Then
        If XMOSM2.text <> "" Then cStr2 = cStr2 & " AND SUBSTRING(MOSM ,1,1) = " & MyParn(XMOSM2.text)
    Else
        If XMOSM2.text <> "" Then cStr2 = cStr2 & " AND ( SUBSTRING(MOSM ,1,1) = 'W' OR SUBSTRING(FILE1_10.MOSM ,1,1) = 'M') "
    End If
    
    If XSECTION.BoundText <> "" Then cStr2 = cStr2 & " AND [SECTION] = " & (XSECTION.BoundText)
    
    If xSupp.BoundText <> "" Then cStr3 = cStr3 & " AND FILE1_10.CODE = " & MyParn(xSupp.BoundText)
    If xGroup.BoundText <> "" Then cStr3 = cStr3 & " AND FILE1_10.[GROUP] = " & MyParn(xGroup.BoundText)
    
    If xSupp.BoundText <> "" Then cStr31 = cStr31 & " AND FILE1_10_2.CODE = " & MyParn(xSupp.BoundText)
    If xGroup.BoundText <> "" Then cStr31 = cStr31 & " AND FILE1_10_2.[GROUP] = " & MyParn(xGroup.BoundText)
...
'   If IsDate(xdate1.Value) Then cStr2 = cStr2 & " AND [DATE] >= " & DateSq(xdate1.Value)
    ...
    If xmosm20.text <> "" Then cStr2 = cStr2 & " AND MOSM2 = " & MyParn(xmosm20.text)
    If xage.BoundText <> "" Then cStr2 = cStr2 & " AND MODELAGE = " & MyParn(xage.BoundText)
    If xsex.BoundText <> "" Then cStr2 = cStr2 & " AND MODELSEX = " & MyParn(xsex.BoundText)
    
    If xall(0).Value <> 0 Then cStr2 = cStr2 & " AND ISBRANCH = 1 "
    If xall(1).Value <> 0 Then cStr2 = cStr2 & " AND ISBRANCH = 0 "
    
    If SEC(3).Value <> 0 Then
        cFieldCount2 = ",(SELECT COUNT(DISTINCT FILE1_10_2.MODEL) FROM FILE1_10 AS FILE1_10_2 INNER JOIN FILE1_11_ALL AS FILE1_11_ALL_2 ON FILE1_10_2.ITEM = FILE1_11_ALL_2.ITEM WHERE FILE1_10_2.ISNODEM = 0 AND FILE1_10_2.MODELAGE = FILE0_82.CODE " & cStr2 & cStr31 & " )    "
        cString = " SELECT  FILE0_82.CODE , FILE0_82.DESCA , ' ' AS N2 , ' ' AS N3 , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & cFieldCount2 & _
                " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM LEFT OUTER JOIN FILE0_82 ON FILE1_10.MODELAGE = FILE0_82.CODE  WHERE file1_10.ISNOITEM = 0 "
    End If
    
    If SEC(0).Value <> 0 Then
        cFieldCount2 = ",(SELECT COUNT(DISTINCT FILE1_10_2.MODEL) FROM FILE1_10 AS FILE1_10_2 INNER JOIN FILE1_11_ALL AS FILE1_11_ALL_2 ON FILE1_10_2.ITEM = FILE1_11_ALL_2.ITEM WHERE FILE1_10_2.ISNODEM = 0 AND FILE1_10_2.MODELAGE = FILE0_82.CODE AND FILE1_10.MOSM = FILE1_10_2.MOSM " & cStr2 & cStr31 & " )    "
        cString = " SELECT  FILE0_82.CODE , FILE0_82.DESCA , FILE1_10.[MOSM], FILE1_10.[MOSM] , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & cFieldCount2 & _
                " FROM  FILE1_10 LEFT OUTER JOIN FILE0_82 ON FILE1_10.MODELAGE = FILE0_82.CODE INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  WHERE file1_10.ISNOITEM = 0 "
    End If
    If SEC(1).Value <> 0 Then
        cFieldCount2 = ",(SELECT COUNT(DISTINCT FILE1_10_2.MODEL) FROM FILE1_10 AS FILE1_10_2 INNER JOIN FILE1_11_ALL AS FILE1_11_ALL_2 ON FILE1_10_2.ITEM = FILE1_11_ALL_2.ITEM WHERE FILE1_10_2.ISNODEM = 0 AND FILE1_10_2.MODELAGE = FILE0_82.CODE AND FILE1_10.MODELSEX = FILE1_10_2.MODELSEX " & cStr2 & cStr31 & " )    "
        cString = " SELECT  FILE0_82.CODE , FILE0_82.DESCA , FILE1_10.MODELSEX , FILE0_81.DESCA AS factdesca , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & cFieldCount2 & _
                " FROM  file1_10 LEFT OUTER JOIN FILE0_82 ON FILE1_10.MODELAGE = FILE0_82.CODE INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  LEFT JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX WHERE file1_10.ISNOITEM = 0 "
    End If
    ...
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & cStr3 & " GROUP BY FILE0_82.CODE , FILE0_82.DESCA , FILE1_10.MOSM ORDER BY FILE0_82.CODE , FILE1_10.MOSM "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & cStr3 & " GROUP BY FILE0_82.CODE , FILE0_82.DESCA , FILE1_10.MODELSEX , FILE0_81.DESCA ORDER BY FILE0_82.CODE , FILE1_10.MODELSEX "
    End If
    If SEC(2).Value <> 0 Then
        cString = cString & cStr2 & cStr3 & " GROUP BY FILE0_82.CODE , FILE0_82.DESCA ORDER BY FILE0_82.CODE "
    End If
    If SEC(3).Value <> 0 Then
        cString = cString & cStr2 & cStr3 & " GROUP BY FILE0_82.CODE , FILE0_82.DESCA ORDER BY FILE0_82.CODE "
    End If
