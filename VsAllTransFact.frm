...
Begin VB.Form VsAllTransFact 
   Caption         =   "≈Ã„«·Ï ﬁÌ„… Ê ⁄œœ ·„ÊœÌ·«  «·„’«‰⁄ «·Ê«—œ… ··›—⁄"
   ClientHeight    =   10230
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1215
         Picture         =   "VsAllTransFact.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3600
         Picture         =   "VsAllTransFact.frx":27EB
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "VsAllTransFact.frx":4CDD
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   555
         Left            =   2430
         Picture         =   "VsAllTransFact.frx":7149
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsAllTransFact.frx":9573
      Height          =   7290
      Left            =   90
      TabIndex        =   1
      Top             =   2250
   ...
   End
End
Attribute VB_Name = "VsAllTransFact"
...
Private Sub cmdPrint_Click()
    ...
    printGrdNew.DOPRINT GRID1, 0.8, -2, cHead1, cHead2, , , , False, 8
    printGrdNew.Show 1
End Sub
...
'                           0               1                 2                3               4                5
    ...
    If SEC(1).Value <> 0 Then
        cString = " SELECT  FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.MODELSEX , FILE0_81.DESCA AS factdesca , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)" & _
                " FROM  FILE1_10 INNER JOIN FILE4_10 ON FILE1_10.code = FILE4_10.CODE INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  LEFT JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX WHERE file1_10.ISNOITEM = 0 "
    End If
    
    If SEC(2).Value <> 0 Then
        cString = " SELECT  FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.MODELAGE, FILE0_82.DESCA , ' ' AS N4 " & _
                    cField & " , SUM([IN]-[OUT]) , SUM(([IN]-[OUT]) * FILE1_11_ALL.COST ) , COUNT(DISTINCT FILE1_10.MODEL)  " & _
                " FROM  FILE1_10 INNER JOIN FILE4_10 ON FILE1_10.code = FILE4_10.CODE INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  LEFT JOIN FILE0_82 ON FILE0_82.CODE = FILE1_10.MODELAGE WHERE file1_10.ISNOITEM = 0 "
    End If
...
'    If IsDate(xdate1.Value) Then cStr2 = cStr2 & " AND [DATE] >= " & DateSq(xdate1.Value)
    ...
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.MOSM ORDER BY FILE4_10.CODE "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.MODELSEX , FILE0_81.DESCA ORDER BY FILE4_10.CODE "
    End If
    If SEC(2).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.MODELAGE, FILE0_82.DESCA  ORDER BY FILE4_10.CODE "
    End If
    If SEC(3).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.CODE , FILE4_10.DESCA , FILE1_10.FACT, FACT.DESCA ORDER BY FILE4_10.CODE "
    End If
...
With GRID1
    ...
    If SEC(3).Value <> 0 Then .TextMatrix(0, 3) = "«·„’‰⁄"
