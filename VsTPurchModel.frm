...
Begin VB.Form VsTPurchModel 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton CMD_PRINT 
            Height          =   465
            Left            =   1260
            Picture         =   "VsTPurchModel.frx":0000
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   26
            Top             =   135
         ...
         Begin VB.CommandButton cmdExit 
            Height          =   465
            Left            =   45
            Picture         =   "VsTPurchModel.frx":242A
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   25
            Top             =   135
         ...
         Begin VB.CommandButton cmdGo 
            Height          =   465
            Left            =   2475
            Picture         =   "VsTPurchModel.frx":4896
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   24
            ToolTipText     =   "⁄—÷"
         ...
         Begin Threed.SSCommand cmd_excel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "VsTPurchModel.frx":6D88
            Caption         =   " ÕÊÌ· «ﬂ”Ì· "
            Alignment       =   4
            PictureAlignment=   1
         End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTPurchModel.frx":9583
      Height          =   6525
      Left            =   45
      TabIndex        =   1
      Top             =   2925
   ...
   End
End
Attribute VB_Name = "VsTPurchModel"
...
'                           0               1                 2                3               4                5
    ...
    cString = cString & " ' ' AS N1 , FACT.desca , file1_10.ModelNo , file1_10.mosm , file1_10.MODELFACT0, file1_10.desca ,   " & _
            " SUM(QFILE7_20.QUANT) , SUM(QFILE7_20.QUANT*QFILE7_20.price) , SUM((QFILE7_20.QUANT*QFILE7_20.price)-QFILE7_20.total) + SUM((QFILE7_20.total * QFILE7_20.R_DISC  ) /100)  , SUM((QFILE7_20.total * ((100-QFILE7_20.R_DISC)/100))* (QFILE7_20.R_TAX2/100)), SUM(QFILE7_20.TOTAL * QFILE7_20.R_TAX) , file1_10.price ,  SUM( file1_10.price * QFILE7_20.QUANT) " & _
            " FROM FILE1_10 INNER JOIN QFILE7_20 ON FILE1_10.ITEM = QFILE7_20.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE inner join file4_10 on file4_10.code = QFILE7_20.code WHERE FILE1_10.MODELNO IS NOT NULL "
    ...
    cString = cString & cStr2 & " GROUP BY file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca , file1_10.price ORDER BY file1_10.ModelNo "
...
With GRID1
    ...
    For i = 6 To .Cols - 1
        If nCol <> 11 Then .Subtotal flexSTSum, -1, i, "#0", vbRed, vbYellow, True, "  "
    Next i
