...
Begin VB.MDIForm main 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin Threed.SSCommand cmd_tmInput_ALL_Tab 
         ...
         ShapeSize       =   1
      End
      Begin Threed.SSCommand cmd_tmTargetBr 
         Height          =   330
         Left            =   6840
         TabIndex        =   4
         TabStop         =   0   'False
      ...
      Begin Threed.SSCommand cmd_tmDashBoard 
         ...
         ShapeSize       =   1
      End
      Begin Threed.SSCommand cmd_tm_grd_balance_all 
         Height          =   330
         Left            =   5130
         TabIndex        =   6
         TabStop         =   0   'False
   ...
   Begin VB.Menu mnCASH 
      ...
      Begin VB.Menu tmInput_ALL_Tab 
         Caption         =   " ﬁ«—Ì— «·Ê«—œ „Ã„⁄…"
      End
      Begin VB.Menu tm_grd_balance_all 
         Caption         =   " ﬁ—Ì—  ›’Ì·Ì «·Õ—ﬂ…"
      End
...
Private Sub cmd_tmTargetBr_Click()
tmTargetBr_Click
End Sub
...
Private Sub cmd_tmdashonline_Click()
tmdashonline_Click
End Sub
...
Private Sub tm_grd_balance_all_Click()
grdBalanceAll.Show
End Sub
...
Private Sub tm_mobile_app_Click()
'MobilSettingfrm.Show
apiStockTransfrm.Show
End Sub
...
aCommandSub = AddFlag(Empty, "name", cmd_tmdashonline.Name)
aCommandSub = AddFlag(aCommandSub, "control", tmdashonline.Name)
aCommandSub = AddFlag(aCommandSub, "visible", tmdashonline.Visible)
...
aCommandSub = AddFlag(Empty, "name", cmd_tm_grd_balance_all.Name)
aCommandSub = AddFlag(aCommandSub, "control", tm_grd_balance_all.Name)
aCommandSub = AddFlag(aCommandSub, "visible", tm_grd_balance_all.Visible)
aCommand = AddFlag(aCommand, aCommandSub)

aCommandSub = AddFlag(Empty, "name", cmd_tmTargetBr.Name)
aCommandSub = AddFlag(aCommandSub, "control", tmTargetBr.Name)
aCommandSub = AddFlag(aCommandSub, "visible", tmTargetBr.Visible)
aCommand = AddFlag(aCommand, aCommandSub)
