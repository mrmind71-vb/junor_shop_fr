...
Begin VB.Form VsTSalesGtoup 
   Caption         =   "≈Ã„«·Ï „»Ì⁄«  „ÊœÌ·«   „Ã„Ê⁄«   ·› —…"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTSalesGtoup.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTSalesGtoup.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTSalesGtoup.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTSalesGtoup.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSalesGtoup.frx":9583
      Height          =   7470
      Left            =   90
      TabIndex        =   1
      Top             =   1980
   ...
   End
End
Attribute VB_Name = "VsTSalesGtoup"
...
Private Sub CMD_PRINT_Click()
    ...
    cHead1 = "≈Ã„«·Ï „»Ì⁄«  «·„Ã„Ê⁄«  " & XSTORE.text & "  " & xGrCust.text
...
Private Sub Form_Load()
    ...
    DATA11.RecordSource = "Select Code,DescA From File0_82  order by Desca"
    Set xage.RowSource = DATA11
    xage.ListField = "Desca"
    xage.BoundColumn = "Code"
    
    DATA12.ConnectionString = strCon
    DATA12.RecordSource = "Select Code,DescA From File0_81  order by Desca"
...
'                           0               1                 2                3               4                5
    ...
    If SEC(0).Value <> 0 Then
        cString = " SELECT FILE1_10.[GROUP] , FILE1_50.DESCA , File0_82.DESCA ,   " & _
                ...
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM left JOIN FILE0_82 ON FILE0_82.CODE = FILE1_10.MODELAGE LEFT JOIN FILE1_50 ON FILE1_50.CODE = FILE1_10.[GROUP]   WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    If SEC(1).Value <> 0 Then
        cString = " SELECT FILE1_10.[GROUP] , FILE1_50.DESCA  , FILE0_81.DESCA ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100))  - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM left JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX LEFT JOIN FILE1_50 ON FILE1_50.CODE = FILE1_10.[GROUP]   WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    If SEC(2).Value <> 0 Then
        cString = " SELECT FILE1_10.[GROUP] , FILE1_50.DESCA , ' ' AS mosm ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100))  - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM  INNER JOIN FILE1_50 ON FILE1_50.CODE = FILE1_10.[GROUP] LEFT JOIN File0_82  ON File0_82.CODE = FILE1_10.MODELAGE  WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    ...
    End If
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE1_10.[GROUP] , FILE1_50.DESCA  , File0_82.[DESCA]    ORDER BY FILE1_10.[group]  ,File0_82.[DESCA] "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE1_10.[GROUP] , FILE1_50.DESCA  , FILE0_81.[DESCA]    ORDER BY FILE1_10.[group] , FILE0_81.[DESCA]"
    End If
...
With GRID1
    ...
    .TextMatrix(0, 0) = "ﬂÊœ"
    .TextMatrix(0, 1) = "«·„Ã„Ê⁄… "
    If SEC(0).Value <> 0 Then .TextMatrix(0, 2) = "›∆… ⁄„—Ì…"
