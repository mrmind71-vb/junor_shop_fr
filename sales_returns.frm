   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_returns.frx":0000
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand CMD_SEND 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_returns.frx":2323
         Caption         =   " ”ÃÌ· «·„— Ã⁄"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         ...
         ShapeSize       =   1
         PictureDisabled =   "sales_returns.frx":498A
      End
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_returns.frx":6C80
         Caption         =   "«Œ Ì«— ﬂ· «·›« Ê—…"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_returns.frx":9156
      End
   End
End
