...
Begin VB.Form TDaySal_2 
   ...
   Begin TabDlg.SSTab sstab1 
      ...
      TabPicture(0)   =   "TDaySal_2_delete.frx":0000
      ...
      TabPicture(1)   =   "TDaySal_2_delete.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "PRINT1"
      Tab(1).Control(1)=   "GRID3"
      ...
      Begin Threed.SSCommand PRINT1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_2_delete.frx":0038
         Caption         =   "ÿ»«⁄…  ›’Ì·Ï »Ê‰«  «·»Ì⁄"
         Alignment       =   4
         PictureAlignment=   10
      End
      Begin Threed.SSCommand print2 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "TDaySal_2_delete.frx":2472
         Caption         =   "≈Ã„«·Ï »Ê‰«  «·»Ì⁄"
         Alignment       =   4
         PictureAlignment=   10
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   600
         Left            =   90
         Picture         =   "TDaySal_2_delete.frx":48AC
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   225
