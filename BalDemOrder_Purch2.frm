...
Begin VB.Form BalDemOrder_Purch2 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   1725
         Picture         =   "BalDemOrder_Purch2.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   135
         Picture         =   "BalDemOrder_Purch2.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   180
   ...
   End
End
Attribute VB_Name = "BalDemOrder_Purch2"
...
''''SELECT        BAL_DEM_ORDER_ITEM.DATE, BAL_DEM_ORDER_ITEM.DOC_NO, BAL_DEM_ORDER_ITEM.CODE, FILE4_10.DESCA, BAL_DEM_ORDER_ITEM.STORE, STORE_BR.DESCA AS NAME_STORE, BAL_DEM_ORDER_ITEM.ISEND_ORDER, COUNT(DISTINCT BAL_DEM_ORDER_ITEM.MODEL) AS COUNT_MODEL, SUM(BAL_DEM_ORDER_ITEM.DEM) AS DEM , SUM(BAL_DEM_ORDER_ITEM.DEM * BAL_DEM_ORDER_ITEM.PRICE) AS TOTAL
''''FROM         BAL_DEM_ORDER_ITEM INNER JOIN FILE4_10 ON BAL_DEM_ORDER_ITEM.CODE = FILE4_10.CODE INNER JOIN STORE_BR ON BAL_DEM_ORDER_ITEM.STORE = STORE_BR.CODE
''''GROUP BY BAL_DEM_ORDER_ITEM.DATE, BAL_DEM_ORDER_ITEM.DOC_NO, BAL_DEM_ORDER_ITEM.CODE, FILE4_10.DESCA, BAL_DEM_ORDER_ITEM.STORE, STORE_BR.DESCA,  BAL_DEM_ORDER_ITEM.ISEND_ORDER
    
    cString = " SELECT  date , doc_no , code , FILE4_10.desca , STORE, STORE_BR.DESCA ,  ISEND_ORDER, sum(count_model) , sum(quant) , sum(total) , sum(count_model_2) , sum(quant_2) , sum(total_2) , 0 , MAX(DATE_PURCH) , remark "
