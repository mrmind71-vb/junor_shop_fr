...
cString = "SELECT T_SAL_RET.date, Sum(T_SAL_RET.TOTAL) AS TSALES , Sum(T_SAL_RET.T_COST) AS T_COST FROM T_SAL_RET "
...
cString = cString & " GROUP BY T_SAL_RET.date"
...
'    End If
    ...
    temptable!val3 = sourcetable!tSALES
    temptable!Val7 = sourcetable!tSALES - sourcetable!T_COST
