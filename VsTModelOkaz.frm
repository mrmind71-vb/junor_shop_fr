...
Begin VB.Form VsTModelOkaz 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTModelOkaz.frx":9583
      Height          =   6525
      Left            =   45
      TabIndex        =   1
      Top             =   2925
   ...
   End
End
Attribute VB_Name = "VsTModelOkaz"
...
'and ( QFILE6_20.username_disc IS NULL OR QFILE6_20.username_disc = '' )
    cString = "SELECT  FACT.desca , file1_10.ModelNo , file1_10.mosm , file1_10.MODELFACT0, file1_10.desca , MIN(FILE1_10.PRICE) , " & _
            " SUM(QFILE6_20.QUANT) , SUM(QFILE6_20.QUANT * QFILE6_20.price_c ) , sum((QFILE6_20.QUANT * QFILE6_20.price_c )-QFILE6_20.total ) , SUM(QFILE6_20.TOTAL * ((QFILE6_20.RATE)/100)) AS DISC2 ,0 , SUM(QFILE6_20.TOTAL * (((100-QFILE6_20.RATE)/100)) )  " & _
            " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE inner join file4_10 on file4_10.code = file1_10.code WHERE ( QFILE6_20.username_disc IS NULL OR QFILE6_20.username_disc = '' ) "
...
With GRID1
    ...
    For nRow = 1 To .Rows - 1
        nRate = 0
        .TextMatrix(nRow, 10) = Val(.TextMatrix(nRow, 8)) + Val(.TextMatrix(nRow, 9))
        NTDIS = Val(.TextMatrix(nRow, 10))
        If Val(.TextMatrix(nRow, 7)) <> 0 Then nRate = Round(NTDIS / Val(.TextMatrix(nRow, 7)) * 100, 2)
