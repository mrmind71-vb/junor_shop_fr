...
cString = "SELECT FR7_20H.DOC_NO,FR7_20H.MOSM ,FR7_20H.INV_NO, FR7_20H.DATE, SUM(FR7_20.TOTAL) as sumOfTotal , SUM(FR7_20.QUANT * FR7_20.PRICE ) as TITEM , FR7_20H.DISCOUNT, FR7_20H.TAX,FR7_20H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA AS GROUPDESCA,BRANCH_FR.DESCA AS STORENAME " & _
         " FROM ((FR7_20H INNER JOIN FR7_20 ON FR7_20H.doc_no =   FR7_20.doc_no) inner join file4_10 on FR7_20H.CODE = FILE4_10.CODE) LEFT JOIN FILE4_50 ON FILE4_10.[GROUP] = FILE4_50.CODE INNER JOIN BRANCH_FR ON BRANCH_FR.CODE = FR7_20H.STORE "

If Trim(xCode.text) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FR7_20H.CODE = " & MyParn(xCode.text)
    aHeader(0) = "[" & "«·„Ê—œ : " & xCodeDesca.Caption & "]"
End If
If Trim(xMosm.BoundText) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FR7_20H.mosm = " & MyParn(xMosm.BoundText)
    aHeader(1) = "[" & "„Ê”„ : " & xMosm.text & "]"
End If
If Trim(XSTORE.BoundText) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FR7_20H.STORE = " & MyParn(XSTORE.BoundText)
...
If IsDate(xdate1.text) Then
    cWhere = cWhere & turnFound(cWhere, " and ") & " FR7_20H.date >= " & DateSq(xdate1.text)
    aHeader(3) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

If IsDate(xDate2.text) Then
    cWhere = cWhere & turn(cWhere, " and ") & " FR7_20H.date <= " & DateSq(xDate2.text)
    aHeader(3) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

cString = cString & turnFound(cWhere) & cWhere
cString = cString & " GROUP BY BRANCH_FR.DESCA ,  FR7_20H.DOC_NO,FR7_20H.MOSM ,FR7_20H.INV_NO, FR7_20H.DATE, FR7_20H.DISCOUNT ,FR7_20H.TAX,FR7_20H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA"
