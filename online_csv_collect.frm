...
Begin VB.Form onlineCSVCollectfrm 
   BackColor       =   &H80000005&
   Caption         =   "”Õ» ÿ·»Ì«  „‰ „·› CSV"
   ClientHeight    =   11055
   ClientLeft      =   60
   ...
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_csv_collect.frx":0000
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ...
         ShapeSize       =   1
         PictureDisabled =   "online_csv_collect.frx":2925
      End
      Begin Threed.SSCommand cmdScv 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_csv_collect.frx":5179
         Caption         =   "› Õ „” ‰œ CSV"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_csv_collect.frx":774C
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_csv_collect.frx":9A42
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
   ...
   End
End
Attribute VB_Name = "onlineCSVCollectfrm"
...
If loctable.RecordCount > 1 Then
    ...
    End If
    pGrid.TextMatrix(Row, 2) = ""
    pGrid.TextMatrix(Row, 3) = ""
    pGrid.TextMatrix(Row, 4) = ""
    pGrid.TextMatrix(Row, 5) = ""
    pGrid.TextMatrix(Row, 6) = ""
    pGrid.TextMatrix(Row, 7) = ""
    GrdDesc = True
    Exit Function
End If
...
End If
    ...
    pGrid.TextMatrix(Row, 4) = loctable!Name & ""
    ...
    If Trim(cSv.GetCellByName(i, "ID")) <> "" Then
