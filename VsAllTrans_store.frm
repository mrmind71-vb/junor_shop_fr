...
Begin VB.Form VsAllTrans_store 
   Caption         =   "⁄œœ ﬁÌ„… Ê«—œ Ê „»Ì⁄«  Ê —’Ìœ «·›—Ê⁄ Ê «· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1230
         Picture         =   "VsAllTrans_store.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3600
         Picture         =   "VsAllTrans_store.frx":27EB
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "VsAllTrans_store.frx":4CDD
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   135
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   555
         Left            =   2430
         Picture         =   "VsAllTrans_store.frx":7149
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   135
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsAllTrans_store.frx":9573
      Height          =   6390
      Left            =   45
      TabIndex        =   1
      Top             =   2745
   ...
   End
End
Attribute VB_Name = "VsAllTrans_store"
...
Private Sub cmdPrint_Click()
    ...
    cHead1 = "⁄œœ ﬁÌ„… Ê«—œ Ê „»Ì⁄«  Ê —’Ìœ ··„ÊœÌ·«  ··›—Ê⁄ " & XSTORE.text
...
'   If IsDate(xDate1.Value) Then cStr2 = cStr2 & " AND [DATE] >= " & DateSq(xDate1.Value)
    ...
    cString = " SELECT  STORE_BR.CODE , STORE_BR.DESCA  , ' ' , ' ' , ' '  " & _
            ...
            " FROM    FILE1_10 INNER JOIN FILE4_10 ON FILE1_10.code = FILE4_10.CODE INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM  INNER JOIN STORE_BR ON STORE_BR.CODE = FILE1_11_ALL.STORE WHERE file1_10.ISNOITEM = 0 "
