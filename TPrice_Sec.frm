...
Begin VB.Form TPrice_SEC 
   Caption         =   " ﬁÌ„ „ÊœÌ·«  «·«ﬁ”«„  »√”⁄«— «·„’‰⁄ Ê «· ﬂ·›… Ê «·»Ì⁄"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   16995
...
'                           0               1                   2
    If xall(0).Value Then
        cString = "SELECT file1_10SC.[CODE] , file1_10SC.desca , SUM( FILE1_11.[IN] -FILE1_11.OUT) , " & _
                ...
                " FROM FILE1_10 INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM LEFT JOIN file1_10SC ON file1_10SC.[CODE] = FILE1_10.[SECTION] WHERE FILE1_10.MODELNO IS NOT NULL "
    ElseIf xall(1).Value Then
        cString = " SELECT file1_10SC.[CODE] , file1_10SC.desca , SUM( FR1_11.[IN] -FR1_11.OUT) , " & _
                ...
                " FROM FILE1_10 INNER JOIN FR1_11 ON FILE1_10.ITEM = FR1_11.ITEM LEFT JOIN file1_10SC ON file1_10SC.[CODE] = FILE1_10.[SECTION] WHERE FILE1_10.MODELNO IS NOT NULL "
    Else
        cString = " SELECT file1_10SC.[CODE] , file1_10SC.desca , SUM( FILE1_11_ALL.[IN] -FILE1_11_ALL.OUT) , " & _
                ...
                " FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM LEFT JOIN file1_10SC ON file1_10SC.[CODE] = FILE1_10.[SECTION] WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
