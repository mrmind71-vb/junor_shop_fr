...
Begin VB.Form salesFrm2 
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.CommandButton DAYALL 
         Height          =   450
         Left            =   45
         Picture         =   "Sales_receipt.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   92
         Top             =   180
         Width           =   600
      ...
      Begin VB.Frame FRM_CLOSED 
         ...
         Begin Threed.SSCommand cmdAddItems 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "Sales_receipt.frx":24F2
            Caption         =   " ”ÃÌ· „ÊœÌ·«  "
            Alignment       =   8
            PictureAlignment=   6
         End
         Begin Threed.SSCommand cmd_CLOSEDDATE 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "Sales_receipt.frx":4CFA
            Caption         =   "≈€·«ﬁ › —…"
            Alignment       =   8
            PictureAlignment=   6
         End
         Begin Threed.SSCommand cmd_open 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "Sales_receipt.frx":77CF
            Caption         =   "› Õ › —…"
            Alignment       =   8
            PictureAlignment=   6
         End
   ...
   Begin VB.Frame Frame10 
      ...
      Begin Threed.SSCommand LOOKPH 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":A301
         Caption         =   "≈” ⁄·«„ ’Ê—"
         Alignment       =   1
         ButtonStyle     =   1
         PictureAlignment=   10
   ...
   Begin VB.PictureBox Picture4 
      ...
      Height          =   2400
      Left            =   900
      Picture         =   "Sales_receipt.frx":C85F
      ScaleHeight     =   2400
      ScaleWidth      =   3165
      TabIndex        =   50
      Top             =   4095
   ...
   Begin VB.PictureBox Picture5 
      ...
      Height          =   2445
      Left            =   4140
      Picture         =   "Sales_receipt.frx":FF36
      ScaleHeight     =   2445
      ScaleWidth      =   3210
      TabIndex        =   74
      Top             =   6615
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   3255
      Left            =   11340
      Picture         =   "Sales_receipt.frx":1360D
      ScaleHeight     =   3255
      ScaleWidth      =   3885
      TabIndex        =   64
      Top             =   6615
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   600
         Left            =   45
         Picture         =   "Sales_receipt.frx":1730B
         Style           =   1  'Graphical
         TabIndex        =   62
         Top             =   135
         Width           =   1095
      ...
      Begin VB.CommandButton CmdDel 
         ...
         Left            =   1125
         MaskColor       =   &H00FFFFFF&
         Picture         =   "Sales_receipt.frx":19777
         Style           =   1  'Graphical
         TabIndex        =   61
         TabStop         =   0   'False
         Top             =   135
      ...
      Begin VB.CommandButton cmdNewInv 
         ...
         Left            =   2205
         MaskColor       =   &H00FFFFFF&
         Picture         =   "Sales_receipt.frx":1C011
         Style           =   1  'Graphical
         TabIndex        =   60
         TabStop         =   0   'False
         Top             =   135
      ...
      Begin VB.CommandButton CmdInform 
         ...
         Height          =   600
         Left            =   3285
         Picture         =   "Sales_receipt.frx":1E5BD
         Style           =   1  'Graphical
         TabIndex        =   59
         TabStop         =   0   'False
         Top             =   135
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "Sales_receipt.frx":20D90
         Style           =   1  'Graphical
         TabIndex        =   53
         ToolTipText     =   "Õ›Ÿ"
         Top             =   90
      ...
      Begin VB.CommandButton CmdUndo 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "Sales_receipt.frx":230F3
         Style           =   1  'Graphical
         TabIndex        =   52
         TabStop         =   0   'False
         Top             =   630
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   2355
      Left            =   7380
      Picture         =   "Sales_receipt.frx":2566C
      ScaleHeight     =   2355
      ScaleWidth      =   3885
      TabIndex        =   40
      Top             =   6615
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   780
      Left            =   495
      Picture         =   "Sales_receipt.frx":28892
      ScaleHeight     =   780
      ScaleWidth      =   10770
      TabIndex        =   31
      Top             =   9090
   ...
   Begin VB.Frame Frame5 
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":2BD2A
         Alignment       =   1
      End
      ...
      Begin Threed.SSCommand cmd_tsal 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":2E164
         Alignment       =   1
         PictureAlignment=   3
      End
   End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":30D1B
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "Sales_receipt.frx":32EEB
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":35033
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "Sales_receipt.frx":371FB
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":3934A
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "Sales_receipt.frx":3B52A
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Sales_receipt.frx":3D685
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "Sales_receipt.frx":3F841
      End
   End
   Begin VB.PictureBox Picture6 
      ...
      Height          =   1140
      Left            =   7740
      Picture         =   "Sales_receipt.frx":41990
      ScaleHeight     =   1140
      ScaleWidth      =   4470
      TabIndex        =   82
      Top             =   810
   ...
   Begin Threed.SSCommand cmd_closed 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Sales_receipt.frx":4527C
      Alignment       =   4
      PictureAlignment=   9
   End
...
sType = receiptType
If sType = "" Then
    MsgBox "«·„” ‰œ ·« ÌÕ ÊÌ ⁄·Ì ﬂ„Ì« "
    Exit Sub
ElseIf sType = "v" Then
    MsgBox "«·„” ‰œ ÌÕ ÊÌ ⁄·Ì ﬂ„Ì«  „ÊÃ»… Êﬂ„Ì«  ”«·»…"
    Exit Sub
End If

submitReceipt xDoc_No.text, con, sType, sError
...
End If
End Sub
Private Function receiptType() As String
Dim i As Long, nType As Integer
For i = 1 To grid1.Rows - 2
    If grid1.ValueMatrix(i, 10) = 0 Then
    ElseIf nType = 0 Then
        nType = IIf(grid1.ValueMatrix(i, 10) > 0, 1, 2)
    Else
        If nType <> IIf(grid1.ValueMatrix(i, 10) > 0, 1, 2) Then
           receiptType = "v"
          Exit Function
        End If
    End If
Next
If nType <> 0 Then receiptType = IIf(nType = 1, "s", "r")
End Function
