...
Private Sub Form_Load()
    openCon con
    StoreTable.Open "BRANCH_FR", con, adOpenStatic, adLockReadOnly, adCmdTable
...
Private Sub myload()
    ...
    cString = cString & cField3 & cField4 & cField5 & _
                " sum([in] - out) as bal  , " & _
                cField7 & cField8 & _
                " sum(([IN] - [out])* FILE1_10.COST) as VAL_BAL     "
...
Sub FixSubView(cPstr)
    ...
    cStr1 = " CREATE VIEW [Gr_BAL] AS SELECT     dbo.FILE1_10H.MODELNO, dbo.FILE1_10H.[GROUP] " & _
            " FROM FR1_11 INNER JOIN FILE1_10 ON FR1_11.ITEM = FILE1_10.ITEM INNER JOIN FILE1_10H ON FILE1_10.MODEL = FILE1_10H.MODEL Where FILE1_10.MODEL IS NOT NULL " & cPstr & _
            " GROUP BY FILE1_10H.[GROUP], FILE1_10H.MODELNO HAVING SUM(FR1_11.[In] - dbo.FR1_11.OUT) <> 0   "
    con.Execute cStr1

    cStr1 = " CREATE VIEW [Gr_PURCH] AS SELECT     dbo.FILE1_10H.MODELNO, dbo.FILE1_10H.[GROUP] " & _
            " FROM FR1_11 INNER JOIN FILE1_10 ON FR1_11.ITEM = FILE1_10.ITEM INNER JOIN FILE1_10H ON FILE1_10.MODEL = FILE1_10H.MODEL Where ( FR1_11.TYPE = '2' OR FR1_11.TYPE = '7' ) AND (FR1_11.[In] - dbo.FR1_11.OUT) <> 0 " & cPstr & _
            " GROUP BY FILE1_10H.[GROUP], FILE1_10H.MODELNO HAVING SUM(FR1_11.[In] - dbo.FR1_11.OUT) <> 0   "
    con.Execute cStr1

    cStr1 = " CREATE VIEW [Gr_SAL] AS SELECT     dbo.FILE1_10H.MODELNO, dbo.FILE1_10H.[GROUP] " & _
            " FROM FR1_11 INNER JOIN FILE1_10 ON FR1_11.ITEM = FILE1_10.ITEM INNER JOIN FILE1_10H ON FILE1_10.MODEL = FILE1_10H.MODEL Where ( FR1_11.TYPE = '6' ) AND  dbo.FR1_11.OUT  <> 0 " & cPstr & _
            " GROUP BY FILE1_10H.[GROUP], FILE1_10H.MODELNO HAVING SUM(dbo.FR1_11.OUT) <> 0   "
    con.Execute cStr1
