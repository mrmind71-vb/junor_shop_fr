...
Begin VB.Form VsTSalesStore 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSalesStore.frx":0000
      Height          =   7470
      Left            =   90
      TabIndex        =   4
      Top             =   1980
   ...
   End
End
Attribute VB_Name = "VsTSalesStore"
...
With grid1
'                           0               1                 2                3               4                5
    cString = " SELECT file6_20H.STORE , FILE0_40.desca  , " & _
            ...
            " FROM FILE1_10 INNER JOIN FILE6_20 ON FILE1_10.ITEM = FILE6_20.ITEM INNER JOIN FILE6_20H ON FILE6_20.DOC_NO = FILE6_20H.DOC_NO LEFT OUTER JOIN FACT ON FILE1_10.FACT = FACT.CODE  WHERE FILE1_10.MODELNO IS NOT NULL "
    ...
    cString = cString & cStr2 & " GROUP BY file6_20H.STORE , FILE0_40.desca "
...
With grid1
    ...
    If IsDate(xdate2.Text) Then cwhere = cwhere & " AND DATE <= " & DateSq(xDate1.Text)
    For nRow = 1 To .Rows - 1
        .TextMatrix(nRow, 6) = Format(GetDesca("SELECT SUM(VALUE) FROM FILE8_50H INNER JOIN FILE8_50 ON FILE8_50.DOC_NO = FILE8_50H.DOC_NO WHERE FILE8_50.BOX =  " & MyParn(.TextMatrix(nRow, 0)) & cwhere), "#0.00")
    Next nRow
