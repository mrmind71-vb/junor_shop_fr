...
Begin VB.Form VsTFRSalesSUPL 
   Caption         =   "≈Ã„«·Ï „»Ì⁄«  «·„Ê—œÌ‰ ·· ÊﬂÌ·« "
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTFRSalesSUPL.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTFRSalesSUPL.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTFRSalesSUPL.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTFRSalesSUPL.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTFRSalesSUPL.frx":9583
      Height          =   7470
      Left            =   90
      TabIndex        =   1
      Top             =   1980
   ...
   End
End
Attribute VB_Name = "VsTFRSalesSUPL"
...
Private Sub CMD_PRINT_Click()
    ...
    cHead1 = "≈Ã„«·Ï „»Ì⁄«  „Ê—œÌ‰ ·· ÊﬂÌ·«  " & XSTORE.text & "  " & xGrCust.text
...
'                           0               1                 2                3               4                5
    ...
    If Check1.Value <> 0 Then
        cString = " SELECT FILE4_10.CODE , FILE4_10.desca , file1_10.mosm ,   " & _
                " SUM(FR6_20.QUANT) AS t_q, SUM(FR6_20.TOTAL * ((100-FR6_20H.RATE )/100)) AS t_sales, SUM(FR6_20.QUANT * FR6_20.cost) AS t_cost, SUM((FR6_20.TOTAL * ((100-FR6_20H.RATE )/100)) - (FR6_20.QUANT * FR6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN FR6_20 ON FILE1_10.ITEM = FR6_20.ITEM INNER JOIN FR6_20H ON FR6_20.DOC_NO = FR6_20H.DOC_NO INNER JOIN FILE4_10 ON FILE1_10.CODE = FILE4_10.CODE WHERE FILE1_10.MODELNO IS NOT NULL "
    Else
    ...
    If Check1.Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE4_10.CODE , FILE4_10.desca , file1_10.mosm ORDER BY FILE4_10.CODE ,  file1_10.mosm "
    Else
...
With GRID1
    ...
    .TextMatrix(0, 1) = "«·„’‰⁄"
    .TextMatrix(0, 2) = "„Ê”„"
    If Check1.Value = 0 Then .ColHidden(2) = True
