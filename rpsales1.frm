...
cString = "Select itemsales.ITEM,FILE1_10.DESCA,FILE1_10.[GROUP],FILE1_50.DESCA AS FILE1_50DESCA,SUM(total)  AS SUMOFTOTAL,SUM(TCOST)  AS SUMOFCOST   " & _
         " From (itemsales Inner join file1_10 on itemsales.item = file1_10.item)  LEFT JOIN FILE1_50 ON FILE1_10.[GROUP] = FILE1_50.CODE"
...
'If xCash.Value <> 0 And xLater.Value = 0 Then
'    cString = cString & TurnFound(cString) & "SalesDtl.Cash"
'    aHeader(4) = "[" & " ‰ﬁœÌ ›ﬁÿ " & "]"
'End If
'
'If xCash.Value = 0 And xLater.Value <> 0 Then
'    cString = cString & TurnFound(cString) & "(Not SalesDtl)"
'    aHeader(4) = "[" & " ¬Ã· ›ﬁÿ " & "]"
'End If

cString = cString & " GROUP BY itemsales.ITEM,FILE1_10.DESCA,FILE1_10.[GROUP],FILE1_50.DESCA"
sourcetable.Open cString, con, adOpenStatic, adLockReadOnly, adCmdText
Do Until sourcetable.EOF
    temptable.AddNew
    temptable!str1 = sourcetable!Item
    temptable!str2 = sourcetable!DESCA
    temptable!str3 = sourcetable!Group
    temptable!str4 = sourcetable!file1_50desca
    temptable!val3 = Val(sourcetable!sumofTotal & "")
    temptable!Val7 = Val(sourcetable!sumofTotal & "") - Val(sourcetable!SumOfCOST & "")
    temptable!Val8 = Val(sourcetable!SumOfCOST & "")
...
contemp.BeginTrans
contemp.CommitTrans
main.Report1.ReportFileName = App.Path & "\Reports\sales7.rpt"
...
If KeyCode = 112 Then
    ...
    listarray(2, 1) = "(FILE1_10.[GROUP]1 IN (SELECT CODE FROM FILE1_52 WHERE %%DESCA%%) OR FILE1_10.TYPE IN (SELECT CODE FROM FILE1_53 WHERE %%DESCA%%) )"
