...
Begin VB.Form ItemLookPh_a 
   ...
   End
End
Attribute VB_Name = "ItemLookPh_a"
...
Private Sub xbarcode_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        aRet = aGetDesca("SELECT MOSM , FACT , MODELFACT  FROM FILE1_10 WHERE ITEM = " & Val(xbarcode.Text))
