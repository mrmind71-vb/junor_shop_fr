...
Private Sub myload()
    ...
    If xall(0).Value <> 0 Then
        ...
        cField4 = " (SELECT COUNT(DISTINCT FILE1_10_2.MODELNO ) FROM FILE1_11 AS FILE1_11_2 INNER JOIN FILE1_10 AS FILE1_10_2 ON FILE1_11_2.ITEM = FILE1_10_2.ITEM WHERE FILE1_11_2.TYPE = '6' AND FILE1_10_2.[GROUP] = FILE1_50.CODE "
    ...
    If xall(1).Value <> 0 Then
        ...
        If xStore.BoundText <> "" Then
            cField3 = " SUM ( case when ( type = '2' OR type = '7' OR type = 'T' OR type = 'F' ) THEN ([IN] - [OUT])  else 0 end ) AS t_purch    , "
            cField7 = " SUM ( case when ( type = '2' OR type = '7' OR type = 'T' OR type = 'F' ) THEN (([IN] - [OUT]) * FR1_11.COST)  else 0 end ) AS VAL_PURCH     , "
        Else
            cField3 = " SUM ( case when ( type = '2' OR type = '7' ) THEN ([IN] - [OUT])  else 0 end ) AS t_purch    , "
            cField7 = " SUM ( case when (type = '2' OR  type = '7') THEN (([IN] - [OUT]) * FILE1_11.COST )  else 0 end ) AS VAL_PURCH     , "
        End If
    ...
    If xall(2).Value <> 0 Then
        ...
        If xStore.BoundText <> "" Then
            cField3 = " SUM ( case when ( type = '2' OR type = '7' OR type = 'T' OR type = 'F' ) THEN ([IN] - [OUT])  else 0 end ) AS t_purch    , "
            cField7 = " SUM ( case when ( type = '2' OR type = '7' OR type = 'T' OR type = 'F' ) THEN (([IN] - [OUT]) * FILE1_11_ALL.COST)  else 0 end ) AS VAL_PURCH     , "
        Else
            cField3 = " SUM ( case when ( type = '2' OR type = '7' ) THEN ([IN] - [OUT])  else 0 end ) AS t_purch    , "
            cField7 = " SUM ( case when (type = '2' OR  type = '7') THEN (([IN] - [OUT]) * FILE1_11_ALL.COST )  else 0 end ) AS VAL_PURCH     , "
        End If
        
        cField4 = " (SELECT COUNT(DISTINCT FILE1_10_2.MODELNO ) FROM FILE1_11_ALL AS FILE1_11_ALL_2 INNER JOIN FILE1_10 AS FILE1_10_2 ON FILE1_11_ALL_2.ITEM = FILE1_10_2.ITEM WHERE FILE1_11_ALL_2.TYPE = '6' AND FILE1_10_2.[GROUP] = FILE1_50.CODE "
    ...
    cString = "    SELECT FILE1_50.CODE , FILE1_50.DESCA , COUNT(DISTINCT FILE1_10.MODELNO)  , "
    ...
    End If
    If xall(0).Value <> 0 Then
        cString = cString & " FROM  FILE1_10 INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM LEFT OUTER JOIN FILE1_50 ON FILE1_10.[GROUP] = FILE1_50.CODE WHERE FILE1_10.ITEM IS NOT NULL "
        If IsDate(xdate1.text) Then cString = cString & " AND FILE1_11.DATE <= " & DateSq(xdate1.text)
    End If
    If xall(1).Value <> 0 Then
        cString = cString & " FROM  FILE1_10 INNER JOIN FR1_11 ON FILE1_10.ITEM = FR1_11.ITEM LEFT OUTER JOIN FILE1_50 ON FILE1_10.[GROUP] = FILE1_50.CODE WHERE FILE1_10.ITEM IS NOT NULL "
        If IsDate(xdate1.text) Then cString = cString & " AND FR1_11.DATE <= " & DateSq(xdate1.text)
    End If
    If xall(2).Value <> 0 Then
        cString = cString & " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM LEFT OUTER JOIN FILE1_50 ON FILE1_10.[GROUP] = FILE1_50.CODE WHERE FILE1_10.ITEM IS NOT NULL "
