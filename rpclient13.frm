...
Begin VB.Form rpclient13 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex7LCtl.VSFlexGrid grid1 
         ...
         FormatString    =   $"rpclient13.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
cString = "SELECT FILE6_10H.DOC_NO, FILE6_10H.DATE, FILE6_10H.CODE, FILE3_10.DESCA, FILE6_10H.DISCOUNT,FILE6_10H.TAX,SUM(FILE6_10.QUANT * FILE6_10.PRICE) AS TOTALQUANT,SUM(FILE6_10.TOTAL) + FILE6_10H.TAX  - FILE6_10H.DISCOUNT AS TOTAL  " & _
          " FROM (FILE6_10H INNER JOIN FILE6_10 ON FILE6_10H.DOC_NO = FILE6_10.DOC_NO) INNER JOIN FILE3_10 ON FILE6_10H.CODE = FILE3_10.CODE"
cString = cString & turnFound(cWhere) & cWhere
cString = cString & " Group BY FILE6_10H.DOC_NO, FILE6_10H.DATE, FILE6_10H.CODE, FILE3_10.DESCA, FILE6_10H.DISCOUNT,FILE6_10H.TAX"
...
contemp.BeginTrans
contemp.CommitTrans
main.Report1.ReportFileName = App.Path & "\Reports\client13.rpt"
