...
Private Sub Form_Load()
    ...
    Set data1.Recordset = myRecordSet("Select code,desca From STORE_BR ORDER BY S_BRANCH ", con)
...
Private Sub myload()
    ...
    cString = " SELECT  FILE1_10.ITEM , FACT.DESCA AS FACTDESCA, FILE1_10.MOSM, FILE1_10.MODELFACT0, FILE1_10.desca AS DESCA, MIN(FILE1_10.PRICE) AS PRICE,  FILE1_10.SCAL , FILE1_10.COLOR, SUM(FILE1_11.[IN] - FILE1_11.OUT) AS BAL " & _
            " FROM    FILE1_10 INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE INNER JOIN FILE1_11 ON FILE1_10.ITEM = FILE1_11.ITEM "
    ...
    If xbarcode.text <> "" Then cString = cString & turn(cString) & " FILE1_10.item = " & Val(xbarcode.text)
    If Trim(xScal.text) <> "" Then cString = cString & turn(cString) & "FILE1_10.SCAL = " & MyParn(xScal.text)
    If Trim(xColor.text) <> "" Then cString = cString & turn(cString) & MyParnAnd(xColor, "FILE1_10.COLOR")
    cString = cString & " GROUP BY FILE1_10.ITEM   , FACT.DESCA, FILE1_10.MOSM, FILE1_10.MODELFACT0, FILE1_10.desca, FILE1_10.COLOR , FILE1_10.SCAL , file1_10.c_scal  "
    If xisbal.Value <> 0 Then cString = cString & " having SUM(FILE1_11.[IN] - FILE1_11.OUT) > 0 "
    cString = cString & "  order by FACT.DESCA, FILE1_10.MOSM, FILE1_10.MODELFACT0 , file1_10.c_scal "
...
Sub Fixgrd()
    ...
    .TextMatrix(0, 9) = "Õ—ﬂ… „ÊœÌ·"
    .TextMatrix(0, 10) = "—’Ìœ „ÊœÌ· ··›—Ê⁄"
...
With grid1
    ...
    End If
    If Col = 10 Then
        BalModelBranch.xModelFact.text = grid1.TextMatrix(grid1.Row, 3)
        BalModelBranch.xFact.text = grid1.TextMatrix(grid1.Row, 1)
        BalModelBranch.xMosm.BoundText = grid1.TextMatrix(grid1.Row, 2)
        BalModelBranch.xDesca.text = grid1.TextMatrix(grid1.Row, 4)
        BalModelBranch.Show 1
    End If
End With
End Sub
