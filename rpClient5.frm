...
Begin VB.Form rpClient5 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex7LCtl.VSFlexGrid grid1 
         ...
         FormatString    =   $"rpClient5.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
cString = "SELECT File3_11.CODE, File3_10.DESCA, File3_10.[GROUP], FILE3_50.DESCA AS GroupDesca ," & _
          cField1 & "," & _
          cField2 & _
         " FROM (File3_11 INNER JOIN File3_10 ON File3_11.CODE = File3_10.CODE) LEFT JOIN FILE3_50 ON File3_10.[GROUP] = FILE3_50.CODE" & _
         " WHERE FILE3_10.CODE NOT IN(SELECT CODE FROM FILE6_20H WHERE FILE6_20h.DATE >= " & DateSq(xdate1.text) & ")"
...
'        temptable!Date1 = TurnValue(GetDesca("select Max(date) From FILE6_20H where code = " & MyParn(sourcetable!CODE)))
...
contemp.BeginTrans
contemp.CommitTrans
main.Report1.ReportFileName = App.Path & "\Reports\CLIENT5.rpt"
