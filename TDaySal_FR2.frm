...
Begin VB.Form TDaySal_FR 
   ...
   Begin TabDlg.SSTab SSTAB 
      ...
      TabPicture(0)   =   "TDaySal_FR2.frx":6DAB
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "PRINT1"
      Tab(0).Control(1)=   "Grid1"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "≈Ã„«·Ì „»Ì⁄«  «·«’‰«›"
      TabPicture(1)   =   "TDaySal_FR2.frx":6DC7
      ...
      TabPicture(2)   =   "TDaySal_FR2.frx":6DE3
      ...
      TabCaption(3)   =   "„»Ì⁄«  »«·”«⁄…"
      TabPicture(3)   =   "TDaySal_FR2.frx":6DFF
