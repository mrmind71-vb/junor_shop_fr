...
Begin VB.Form VsTBranshBALSupl 
   Caption         =   "≈Ã„«·Ï —’Ìœ „ÊœÌ·«  „Ê—œÌ‰ ⁄œœ - ﬁÌ„…"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTBranshBALSupl.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTBranshBALSupl.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTBranshBALSupl.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTBranshBALSupl.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTBranshBALSupl.frx":9583
      Height          =   7380
      Left            =   135
      TabIndex        =   1
      Top             =   1890
   ...
   End
End
Attribute VB_Name = "VsTBranshBALSupl"
...
With GRID1
'                           0               1                 2                3               4                        5
    cStrall = " SELECT   FILE1_10.CODE , ' ' AS SUPPDESCA, SUM([IN]-[OUT]) , SUM (([IN]-[OUT]) * FILE1_10.COST )    , " & _
                cField2 & _
            " FROM  FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM WHERE file1_10.ISNOITEM = 0 "
    ...
    If xall(1).Value <> 0 Then cStrall = cStrall & " AND FILE1_11_ALL.ISBRANCH = 0 "
    
    cStrall = cStrall & " GROUP BY  FILE1_10.CODE ORDER BY FILE1_10.CODE "
...
With GRID1
    ...
    .TextMatrix(0, 2) = "≈Ã„«·Ï «·—’Ìœ"
    .TextMatrix(0, 3) = "≈Ã„«·Ï «·—’Ìœ"
    ...
    For nRow = 2 To .Rows - 1
        .TextMatrix(nRow, 1) = GetDesca("SELECT DESCA FROM FILE4_10 WHERE CODE = " & MyParn(.TextMatrix(nRow, 0)), con)
