...
Begin VB.Form SearchFACT_SOCK 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "SearchFACT_SOCK.frx":0000
      Height          =   7080
      Left            =   45
      TabIndex        =   3
      Top             =   90
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.Image Image1 
            Height          =   450
            Left            =   4140
            Picture         =   "SearchFACT_SOCK.frx":0013
            Top             =   0
            Width           =   420
         End
      End
   ...
   End
End
Attribute VB_Name = "SearchFACT_SOCK"
...
Ado1.ConnectionString = strConfact2
...
Set Ado1.Recordset = myRecordSet(cString, confact2)
'Ado1.Refresh
FIXGRID
Exit Sub
myerror:
