...
Begin VB.Form NewDocToBranch 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2520
         Picture         =   "NewDocToBranch.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   90
         Picture         =   "NewDocToBranch.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   135
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1305
         Picture         =   "NewDocToBranch.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   135
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "NewDocToBranch.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   End
End
Attribute VB_Name = "NewDocToBranch"
...
Private Sub Form_Load()
    ...
    Set data2.Recordset = myRecordSet("Select Code,DescA From File0_40 WHERE ISSTOREBRANCH = 1 ORDER BY CODE ", con)
...
Private Sub myload()
    ...
    cString = " SELECT flag , Q_NewDoc_Branch.desca, DOC_NO, DATE, [name], QUANT, USERSEND2, TIMESEND2 , FILE0_40.DESCA , Notes_Doc  FROM  Q_NewDoc_Branch  INNER JOIN FILE0_40 ON FILE0_40.CODE = Q_NewDoc_Branch.STORE where DOC_NO is not null "
