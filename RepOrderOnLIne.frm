...
Begin VB.Form RepOrderOnLIne 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "RepOrderOnLIne.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "RepOrderOnLIne.frx":24F2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "RepOrderOnLIne.frx":495E
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   135
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "RepOrderOnLIne.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   End
End
Attribute VB_Name = "RepOrderOnLIne"
...
Private Sub myload0()
    ...
    cString = " SELECT FILE0_40.DESCA, COUNT(QFILE6_90.DOC_NO) AS C_ORDER  , SUM(QUANT) AS T_QUANT , SUM(QFILE6_90.TOTAL) AS T_ORDER , SUM(CASE WHEN SALES_DOC IS NOT NULL THEN 1 ELSE 0 END ) , SUM(CASE WHEN SALES_DOC IS NOT NULL THEN QUANT ELSE 0 END ) , SUM(CASE WHEN SALES_DOC IS NOT NULL THEN TOTAL ELSE 0 END ) " & _
                "FROM            QFILE6_90 LEFT  JOIN FILE0_40 ON QFILE6_90.STORE = FILE0_40.CODE WHERE DOC_NO IS NOT NULL "
...
'    If XORDER_NO.text <> "" Then cString = cString & " AND Q_PURCH_DEM.[ORDER_NO] = " & MyParn(XORDER_NO.text)
    ...
    cString = cString & " GROUP BY QFILE6_90.STORE, FILE0_40.DESCA"
...
Sub Fixgrd0()
    ...
    For nRow = 1 To .Rows - 1
        nRate = 0
        If Val(.TextMatrix(nRow, 1)) <> 0 Then nRate = Round(Val(.TextMatrix(nRow, 4)) / Val(.TextMatrix(nRow, 1)) * 100, 2)
        .TextMatrix(nRow, 8) = nRate
            
        nRate = 0
        If Val(.TextMatrix(.Rows - 1, 1)) <> 0 Then nRate = Round(Val(.TextMatrix(nRow, 1)) / Val(.TextMatrix(.Rows - 1, 1)) * 100, 2)
