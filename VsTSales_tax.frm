...
Begin VB.Form VsTSales_tax 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTSales_tax.frx":0000
      Height          =   7470
      Left            =   90
      TabIndex        =   4
      Top             =   1980
   ...
   End
End
Attribute VB_Name = "VsTSales_tax"
...
Private Sub CMD_PRINT_Click()
    ...
    Load PrintGrd
    PrintGrd.doprint grid1, 1, , cHead1, cHead2, , , True, 7
    PrintGrd.Show 1
End Sub
...
'                           0               1                 2                3               4                5
    ...
    cString = " SELECT file1_10.ModelNo, FACT.desca , file1_10.mosm, file1_10.MODELFACT0, file1_10.desca ,   " & _
            " SUM(FILE6_30.QUANT) AS t_q, SUM(FILE6_30.TOTAL * ((100 - FILE6_30H.rate) / 100)) AS t_sales " & _
            " FROM FILE1_10 INNER JOIN FILE6_30 ON FILE1_10.ITEM = FILE6_30.ITEM INNER JOIN FILE6_30H ON FILE6_30.DOC_NO = FILE6_30H.DOC_NO LEFT OUTER JOIN FACT ON FILE1_10.FACT = FACT.CODE WHERE FILE1_10.MODELNO IS NOT NULL "
    ...
    If xStore.BoundText <> "" Then cStr2 = cStr2 & " AND FILE6_30h.store = " & MyParn(xStore.BoundText)
    If xSection.BoundText <> "" Then cStr2 = cStr2 & " AND FILE1_10.[Section] = " & xSection.BoundText
    If IsDate(xDate1.Text) Then cStr2 = cStr2 & " AND FILE6_30h.[DATE] >= " & DateSq(xDate1.Text)
    If IsDate(xdate2.Text) Then cStr2 = cStr2 & " AND FILE6_30h.[DATE] <= " & DateSq(xdate2.Text)
