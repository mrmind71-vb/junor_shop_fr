...
Private Sub CMD_PRINT_Click()
    ...
    cHead1 = "≈Ã„«·Ï „»Ì⁄«  «·√ﬁ”«„ " & XSTORE.text & "  " & xGrCust.text
...
'                           0               1                 2                3               4                5
    ...
    If SEC(0).Value <> 0 Then
        cString = " SELECT FILE1_10.ModelAge , FILE0_82.DESCA , FILE1_10SC.DESCA ,   " & _
                ...
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM LEFT JOIN FILE1_10SC ON FILE1_10SC.CODE = FILE1_10.[SECTION] LEFT JOIN FILE0_82 ON FILE0_82.CODE = FILE1_10.MODELAGE WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    If SEC(1).Value <> 0 Then
        cString = " SELECT FILE1_10.ModelAge , FILE0_82.DESCA  , FILE0_81.DESCA ,   " & _
                " SUM(QFILE6_20.QUANT) AS t_q, SUM(QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100)) AS t_sales, SUM(QFILE6_20.QUANT * QFILE6_20.cost) AS t_cost, SUM((QFILE6_20.TOTAL * ((100-QFILE6_20.RATE )/100))  - (QFILE6_20.QUANT * QFILE6_20.cost)) AS t_proft " & _
                " FROM FILE1_10 INNER JOIN QFILE6_20 ON FILE1_10.ITEM = QFILE6_20.ITEM left JOIN FILE0_81 ON FILE0_81.CODE = FILE1_10.MODELSEX LEFT JOIN FILE0_82 ON FILE0_82.CODE = FILE1_10.MODELAGE  WHERE FILE1_10.MODELNO IS NOT NULL "
    End If
    ...
    If SEC(2).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE1_10.ModelAge , FILE0_82.DESCA ORDER BY FILE1_10.ModelAge "
    End If
    If SEC(0).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE1_10.ModelAge , FILE0_82.DESCA , FILE1_10.[SECTION] , FILE1_10SC.[DESCA]    ORDER BY FILE1_10.ModelAge , FILE1_10.[SECTION]  "
    End If
    If SEC(1).Value <> 0 Then
        cString = cString & cStr2 & " GROUP BY FILE1_10.ModelAge , FILE0_82.DESCA  , FILE0_81.[DESCA]    ORDER BY FILE1_10.ModelAge "
    End If
...
With GRID1
    ...
    .TextMatrix(0, 0) = "ﬂÊœ"
    .TextMatrix(0, 1) = "›∆… ⁄„—Ì…"
    If SEC(0).Value <> 0 Then .TextMatrix(0, 2) = "ﬁ”„"
