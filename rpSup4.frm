...
data3.RecordSource = "Select CODE ,DescA From FILE0_40 "
...
cString = "SELECT FILE7_20H.DOC_NO,FILE7_20H.MOSM ,FILE7_20H.INV_NO, FILE7_20H.DATE, SUM(FILE7_20.TOTAL) as sumOfTotal , SUM(FILE7_20.QUANT * FILE7_20.PRICE ) as TITEM , FILE7_20H.DISCOUNT, FILE7_20H.TAX,FILE7_20H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA AS GROUPDESCA,FILE0_40.DESCA AS STORENAME " & _
         " FROM ((FILE7_20H INNER JOIN FILE7_20 ON FILE7_20H.doc_no =   FILE7_20.doc_no) inner join file4_10 on file7_20H.CODE = FILE4_10.CODE) LEFT JOIN FILE4_50 ON FILE4_10.[GROUP] = FILE4_50.CODE INNER JOIN FILE0_40 ON FILE0_40.CODE = FILE7_20H.STORE "

If Trim(xCode.text) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FILE7_20H.CODE = " & MyParn(xCode.text)
    aHeader(0) = "[" & "«·„Ê—œ : " & xCodeDesca.Caption & "]"
End If
If Trim(xMosm.BoundText) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FILE7_20H.mosm = " & MyParn(xMosm.BoundText)
    aHeader(1) = "[" & "„Ê”„ : " & xMosm.text & "]"
End If
If Trim(XSTORE.BoundText) <> "" Then
    cWhere = cWhere & turn(cWhere, " AND ") & "FILE7_20H.STORE = " & MyParn(XSTORE.BoundText)
...
If IsDate(xDate2.text) Then
    cWhere = cWhere & turn(cWhere, " and ") & " FILE7_20H.date <= " & DateSq(xDate2.text)
    aHeader(3) = "[" & BetweenString(xdate1.text, xDate2.text) & "]"
End If

cString = cString & turnFound(cWhere) & cWhere
cString = cString & " GROUP BY FILE0_40.DESCA ,  FILE7_20H.DOC_NO,FILE7_20H.MOSM ,FILE7_20H.INV_NO, FILE7_20H.DATE, FILE7_20H.DISCOUNT ,FILE7_20H.TAX,FILE7_20H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA"
