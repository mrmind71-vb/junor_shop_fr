...
Dim ScalTable As New ADODB.Recordset, cStrScal As String
...
Private Sub CMD_PRINT_Click()
    ...
    printGrdNew.DOPRINT GRID1, 1.1, , cHead1, cHead2, cHead3, , False, 10
    printGrdNew.Show 1
End Sub
...
Private Sub myload()
Dim i As Double
Dim cString  As String, cStr2 As String, cString2 As String
With GRID1
'                           0               1                 2                3               4                5
    
    cStrScal = " SELECT  FILE1_10.SCAL FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE inner join file4_10 on file4_10.code = file1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
    If xcust.BoundText <> "" Then cStr2 = cStr2 & " AND FILE1_11_ALL.code = " & MyParn(xcust.BoundText)
    ...
    If xDoc_No.text <> "" Then cStr2 = cStr2 & " AND FILE1_11_ALL.doc_no = " & MyParn(xDoc_No.text)
    ...
    cStrScal = cStrScal & cStr2 & " GROUP BY file1_10.SCAL   ORDER BY file1_10.SCAL  "
    If ScalTable.State = adStateOpen Then ScalTable.Close
    ScalTable.Open cStrScal, con, adOpenStatic, adLockReadOnly, adCmdText
    ...
    With ScalTable
        Do While Not ScalTable.EOF
            cString2 = cString2 & " , " & myiif("FILE1_10.SCAL = " & MyParn(ScalTable!SCAL), "[IN]-[OUT]") & " AS '" & ScalTable!SCAL & "'"
            .MoveNext
        Loop
    End With
    cString = cString & cString2 & " FROM FILE1_10 INNER JOIN FILE1_11_ALL ON FILE1_10.ITEM = FILE1_11_ALL.ITEM INNER JOIN FACT ON FILE1_10.FACT = FACT.CODE inner join file4_10 on file4_10.code = file1_10.code WHERE FILE1_10.MODELNO IS NOT NULL "
