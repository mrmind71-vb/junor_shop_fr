...
Begin VB.Form VsTBranshSalsec 
   Caption         =   "≈Ã„«·Ï „»Ì⁄«  «·√ﬁ”«„  ⁄œœ - ﬁÌ„…"
   ClientHeight    =   10365
   ClientLeft      =   75
   ClientTop       =   450
   ClientWidth     =   11280
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CMD_PRINT 
         Height          =   465
         Left            =   1260
         Picture         =   "VsTBranshSalsec.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   465
         Left            =   45
         Picture         =   "VsTBranshSalsec.frx":242A
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   135
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   465
         Left            =   2475
         Picture         =   "VsTBranshSalsec.frx":4896
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "⁄—÷"
      ...
      Begin Threed.SSCommand cmd_excel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "VsTBranshSalsec.frx":6D88
         Caption         =   " ÕÊÌ· «ﬂ”Ì· "
         Alignment       =   4
         PictureAlignment=   1
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "VsTBranshSalsec.frx":9583
      Height          =   7380
      Left            =   135
      TabIndex        =   1
      Top             =   1890
   ...
   End
End
Attribute VB_Name = "VsTBranshSalsec"
...
With GRID1
'                           0               1                 2                3               4                        5
    cStrall = " SELECT  FILE1_10.[section] , ' ' as SUPPDESCA, SUM(QUANT) , SUM(TOTAL * ((100-QFILE6_20.RATE)/100))  , " & _
                cField2 & _
    ...
    If xall(0).Value <> 0 Then cStrall = cStrall & " AND ISBRANCH = 1 "
    If xall(1).Value <> 0 Then cStrall = cStrall & " AND ISBRANCH = 0 "
    If Not bOpt5 Then cStrall = cStrall & " AND STORE IN (SELECT STORE FROM USERSHOP WHERE CODE = " & nusercode & ")"
    
    
    cStrall = cStrall & " GROUP BY  FILE1_10.[section] ORDER BY FILE1_10.[section] "
...
With GRID1
    ...
    For nRow = 2 To .Rows - 1
        .TextMatrix(nRow, 1) = GetDesca("select desca from file1_10sc where code = " & Val(.TextMatrix(nRow, 0)), con)
