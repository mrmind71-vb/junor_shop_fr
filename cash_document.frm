...
Begin VB.Form cash_document2 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboZoomBy 
         Height          =   315
         ItemData        =   "cash_document.frx":0000
         Left            =   1125
         List            =   "cash_document.frx":0002
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdExit 
         ...
         EndProperty
         Picture         =   "cash_document.frx":0004
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_document.frx":2327
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_document.frx":469D
      End
   End
   ...
   End
End
Attribute VB_Name = "cash_document2"
...
On Error GoTo myerror
csource = Document_Files(xPhoto.Caption)
...
If MyPrinter.ShowPrinter(Me.hwnd) Then
    If MyPrinter.Range = iprAllPages And grid1.Rows - 1 > 0 Then
        For i = 1 To grid1.Rows - 2
            If validPhoto(Document_Files(grid1.TextMatrix(i, grid1.Cols - 1))) Then
                imgx2.Import.FromFile Document_Files(grid1.TextMatrix(i, grid1.Cols - 1))
                MyPrinter.PrintImage "Print Document", imgx2.Images(0), False, True
            End If
        Next
    ElseIf MyPrinter.Range = ixprSelection Then
        If validPhoto(Document_Files(grid1.TextMatrix(i, grid1.Cols - 1))) Then
            imgx2.Import.FromFile Document_Files(grid1.TextMatrix(grid1.Row, grid1.Cols - 1))
...
On Error GoTo myerror
ImgX1.Images.Clear
'If Not MyCreateFolder(doc_dir(sId_cash)) Then Exit Sub
If xPhoto.Caption <> "" Then
    
'    If Dir(Document_Files(xPhoto.Caption)) <> "" Then
'        ImgX1.Import.FromFile Document_Files(xPhoto.Caption)
'    End If
End If
Exit Sub
myerror:
...
ElseIf col = 3 And xPhoto.Caption <> "" Then
    ...
    If Common1.FileTitle <> "" Then
        ...
        If cFile <> "" Then
            cNewFile = Document_Files(xPhoto.Caption)
...
ElseIf col = 4 Then
    If MsgBox("Õ–› «·’Ê—…", vbOKCancel + vbDefaultButton2) Then
        fs.DeleteFile Document_Files(xPhoto.Caption)
        LoadPhoto
    End If
End If
Exit Sub
