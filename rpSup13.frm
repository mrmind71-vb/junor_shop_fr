...
cString = "Select FILE1_11.ITEM,SUM(FILE1_11.[IN] -  FILE1_11.[OUT]) as Balance, FILE1_10.DESCA,FILE1_10.COST " & _
        " From (FILE1_11 INNER JOIN FILE1_10 ON FILE1_11.ITEM = FILE1_10.ITEM) LEFT JOIN FILE4_10 ON FILE1_10.SUPLER = FILE4_10.CODE "

If Trim(xCode.Text) <> "" Then
    cString = cString & turn(cString) & " FILE1_10.SUPLER = " & MyParn(xCode.Text)
...
Do Until sourcetable.EOF
    ...
    temptable!val2 = !cost
    temptable!val3 = Val(!balance & "") * Val(!cost & "")
...
contemp.BeginTrans
contemp.CommitTrans
main.REPORT1.ReportFileName = App.Path & "\Reports\Sup13.rpt"
