...
cField10 = "(select sum(value) from file5_21 WHERE code1 = file4_10.code  and CLOSED = '0' )"
cField11 = "(SELECT  sum(Items_Sales.TOTAL * ((100 - Items_Sales.discount) / 100) )  from Items_Sales inner join file1_10 on file1_10.item = Items_Sales.item  where file1_10.code = file4_10.code and date  >= " & DateSq(xDate1.Text) & " and date <= " & DateSq(xDate2.Text) & " ) "
'sELECT  Items_Sales.TOTAL * ((100 - Items_Sales.discount) / 100) AS tsal, Items_Sales.cost * Items_Sales.OUT AS tcost FROM         FILE1_10 INNER JOIN                       Items_Sales ON FILE1_10.ITEM = Items_Sales.ITEM
...
'                           0                           1
    cString = "  select FILE4_10.CODE AS CODE , FILE4_10.DESCA AS DESCA , " & _
                ...
                cField6 & " , " & cField7 & " , " & cField8 & " , " & cField9 & " , " & cField10 & " , " & cField11 & _
                " FROM (FILE4_11 LEFT JOIN FILE4_10 ON FILE4_11.CODE = FILE4_10.CODE) LEFT JOIN file3_50 ON FILE4_10.[group] = file3_50.CODE WHERE FILE4_10.CODE IS NOT NULL "
